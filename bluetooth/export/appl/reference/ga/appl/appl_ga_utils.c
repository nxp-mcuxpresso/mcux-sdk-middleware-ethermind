...
/* --------------------------------------------- Global Definitions */
/*
 * Address and Type of Local Device - Used for connections and Broadcast
 * Announcements
 */
OWN_ADDR_INFO own_addr_info[2U];
...
{
    {
         ...
         */
        0x04U, GA_ADTYPE_SERVICE_DATA, 0x53U, 0x18U, CAS_GENERAL_ANNOUNCEMENT,
         ...
         *                  X          Metadata
         */
        0x09U, GA_ADTYPE_SERVICE_DATA, 0x4EU, 0x18U, BAP_ASCS_GENERAL_ANNOUNCEMENT, 0x00U, 0x00U, 0x00U, 0x00U, 0x00U,
...
{
    {
         ...
         *                  2U, Value: TMAP Role: 0x00U (Bytes 7-8)
...
APPL_GA_GAP_ADV_DATA * appl_ga_utils_reference_advdata_for_current_role(void);
...
void appl_ga_utils_dev_manager_init(void)
{
    ...
    for (i = 0U; i < MAX_CONN_DEVICES; i++)
    {
        ...
        conn_dev[i].conn_handle = INVALID_CONN_HANDLE;
    }
    conn_dev_in_use = 0U;
    APPL_TRC("Default settings done for device manager\n");

    appl_ga_gap_adv_data.datalen = appl_ga_gap_adv_data.length;
    appl_ga_gap_adv_data_tmap.datalen = appl_ga_gap_adv_data_tmap.length;
    appl_ga_gap_adv_data_hap.datalen = appl_ga_gap_adv_data_hap.length;
    appl_ga_rsilen = 0U;
...
void appl_ga_utils_bap_display_pref_phy_for_input(void)
{
    ...
    CONSOLE_OUT("TMAP Role: CG, M: LE 2M PHY\n");
    CONSOLE_OUT("TMAP Role: CT, M: LE 2M PHY\n");
    CONSOLE_OUT("TMAP Role: UMS, M: LE 2M PHY\n");
    CONSOLE_OUT("TMAP Role: UMR, M: LE 2M PHY\n");
    CONSOLE_OUT("TMAP Role: BMS, M: LE 2M PHY\n");
    CONSOLE_OUT("TMAP Role: BMR, M: LE 2M PHY\n");
    CONSOLE_OUT("HAP Role: HA, M: LE 2M PHY\n");
    CONSOLE_OUT("HAP Role: HARC, M: LE 2M PHY\n");
    CONSOLE_OUT("HAP Role: HAUC, M: LE 2M PHY\n");
...
void appl_ga_utils_bap_display_audio_locations_for_input(void)
{
    ...
    CONSOLE_OUT("TMAP Role: CG, O: Front Left, Front Right\n");
    ...
    CONSOLE_OUT("HAP Role: HA, Binaural Hearing Aid Set, M: Front Left or Front Right\n");
    CONSOLE_OUT("HAP Role: HA, Banded Hearing Aid Set, M: Front Left and Front Right\n");
    CONSOLE_OUT("HAP Role: HAUC, M: Front Left and Front Right\n");
...
#if 1
        /* This is required only in the case while testing with Pixel7 */
        max_supported_opcf = GA_48_6_1_MAXSDUSIZE_BYTES;
#endif /* 0 */

        /*
         * If the new value is Less/Greater than the Min/Max already set,
         * Set the new value as Min/Max.
         */
        if (0x00000000 == csc->supported_opcf)
        {
            csc->supported_opcf |= min_supported_opcf;
        }
        else
        {
            if (min_supported_opcf < (csc->supported_opcf & 0x0000FFFFU))
            {
                csc->supported_opcf |= min_supported_opcf;
            }
        }
...
void appl_ga_utils_bap_display_cs_cap_set_for_input(void)
{
    ...
    CONSOLE_OUT("TMAP Role: CT, M: 16_1, 16_2, 32_1, 32_2\n");
    ...
    CONSOLE_OUT("HAP Role: HA, M: 16_2, 24_2\n");
...
void appl_ga_utils_bap_display_cs_conf_set_for_input(void)
{
    ...
    CONSOLE_OUT("TMAP Role: CG, M: 16_2, 24_2, 32_2\n");
    CONSOLE_OUT("TMAP Role: UMS, M: 16_2, 48_2, 48_4 OR 48_6\n");
    CONSOLE_OUT("TMAP Role: BMS, M: 16_2, 48_1, 48_2, 48_3 OR 48_5, 48_4 OR 48_6\n");
    CONSOLE_OUT("HAP Role: HAUC, M: 16_2\n");
...
{
    /* Refer: Page 87 of BAP spec version 1.0.1, Table: 5.2 */
    ...
    APPL_TRC("   9.      Set 441_1_1 :        441_1                8163us          framed         97                 5                    24ms                40000us\n");
    APPL_TRC("  10.      Set 441_2_1 :        441_2               10884us          framed        130                 5                    31ms                40000us\n");
    ...
    APPL_TRC("  25.      Set 441_1_2 :        441_1                8163us          framed         97                13                    80ms                40000us\n");
    APPL_TRC("  26.      Set 441_2_2 :        441_2               10884us          framed        130                13                    85ms                40000us\n");
    ...
    CONSOLE_OUT("TMAP Role: CG, M: Low Latency: Set 16_2_1, 32_2_1\n");
    CONSOLE_OUT("TMAP Role: CT, M: Low Latency: Set 16_1_1, 16_2_1, 32_1_1, 32_1_1\n"
                "                  High Reliability: Set 16_1_2, 16_2_2, 32_1_2, 32_2_2\n");
    ...
    CONSOLE_OUT("TMAP Role: BMR, M: Low Latency: Set 16_2_1, 24_2_1, 48_1_1, 48_2_1, 48_3_1, 48_4_1, 48_5_1, 48_6_1\n"
                "                   High Reliability: Set 16_2_2, 24_2_2, 48_1_2, 48_2_2, 48_3_2, 48_4_2, 48_5_2, 48_6_2 \n");
    CONSOLE_OUT("HAP Role: HA, M: Low Latency: Set 16_2_1 \n");
    CONSOLE_OUT("HAP Role: HAUC, M: Low Latency: Set 16_2_1 \n");
...
{
    /* Refer: Page 113 of BAP spec version 1.0.1, Table: 6.4 */
    APPL_TRC
    (
        "Set ID.    Set Name:    Codec Cap/Conf Setting    SDU Interval    "
        "Framing    Max SDU Size    Retransmission Num    "
    ...
    APPL_TRC("   7.      Set  32_1_1 :         32_1                7500us        unframed         60                 2                     8ms                40000us\n");
    APPL_TRC("   8.      Set  32_2_1 :         32_2               10000us        unframed         80                 2                    10ms                40000us\n");
    APPL_TRC("   9.      Set 441_1_1 :        441_1                8163us          framed         97                 4                    24ms                40000us\n");
    APPL_TRC("  10.      Set 441_2_1 :        441_2               10884us          framed        130                 4                    31ms                40000us\n");
    ...
    APPL_TRC("  25.      Set 441_1_2 :        441_1                8163us          framed         97                 4                    54ms                40000us\n");
    APPL_TRC("  26.      Set 441_2_2 :        441_2               10884us          framed        130                 4                    60ms                40000us\n");
          ...
          )
{
    ...
    /* For any HAP Role, HAP Mandates 2M Phy */
    /* Set PHY Preference */
    if (NULL != qos_cap)
    {
    ...
    if (NULL != csc)
    {
         ...
         * TMAP Role: UMS, FL, FR
         * TMAP Role: BMS, FL, FR
         * TMAP Role: BMR, FL or FR or FL + FR
         *
         * HAP Role: HA, Binaural Hearing Aid Set, FL or FR
         * HAP Role: HA, Banded Hearing Aid Set, FL and FR
         */
        /* Set Audio Channel Allocation */
...
{
    if (GA_CONTEXT_TYPE_UNSPECIFIED ==
            (contexts & GA_CONTEXT_TYPE_UNSPECIFIED))
    {
        APPL_TRC("\t- Unspecified (0x%04X)\n", GA_CONTEXT_TYPE_UNSPECIFIED);
    }
    if (GA_CONTEXT_TYPE_CONVERSATIONAL ==
            (contexts & GA_CONTEXT_TYPE_CONVERSATIONAL))
    {
        APPL_TRC
        (
    ...
    if (GA_CONTEXT_TYPE_MEDIA == (contexts & GA_CONTEXT_TYPE_MEDIA))
    {
        APPL_TRC("\t- Media (0x%04X)\n", GA_CONTEXT_TYPE_MEDIA);
    }
    if (GA_CONTEXT_TYPE_GAME == (contexts & GA_CONTEXT_TYPE_GAME))
    {
        APPL_TRC("\t- Game (0x%04X)\n", GA_CONTEXT_TYPE_GAME);
    }
    if (GA_CONTEXT_TYPE_INSTRUCTIONAL ==
            (contexts & GA_CONTEXT_TYPE_INSTRUCTIONAL))
    {
        APPL_TRC
        (
    ...
    if (GA_CONTEXT_TYPE_VOICE_ASSISTANTS ==
            (contexts & GA_CONTEXT_TYPE_VOICE_ASSISTANTS))
    {
        APPL_TRC
        (
    ...
    if (GA_CONTEXT_TYPE_LIVE == (contexts & GA_CONTEXT_TYPE_LIVE))
    {
        APPL_TRC("\t- Live (0x%04X)\n", GA_CONTEXT_TYPE_LIVE);
    }
    if (GA_CONTEXT_TYPE_SOUND_EFFECTS ==
            (contexts & GA_CONTEXT_TYPE_SOUND_EFFECTS))
    {
        APPL_TRC
        (
    ...
    if (GA_CONTEXT_TYPE_NOTIFICATIONS ==
            (contexts & GA_CONTEXT_TYPE_NOTIFICATIONS))
    {
        APPL_TRC("\t- Notification (0x%04X)\n", GA_CONTEXT_TYPE_NOTIFICATIONS);
    }
    if (GA_CONTEXT_TYPE_RINGTONE == (contexts & GA_CONTEXT_TYPE_RINGTONE))
    {
        APPL_TRC("\t- Ringtone (0x%04X)\n", GA_CONTEXT_TYPE_RINGTONE);
    }
    if (GA_CONTEXT_TYPE_ALERTS == (contexts & GA_CONTEXT_TYPE_ALERTS))
    {
        APPL_TRC("\t- Alerts (0x%04X)\n", GA_CONTEXT_TYPE_ALERTS);
    }
    if (GA_CONTEXT_TYPE_EMERGENCY_ALARM ==
            (contexts & GA_CONTEXT_TYPE_EMERGENCY_ALARM))
    {
        APPL_TRC
        (
...
{
    if (GA_AUDIO_LOCATION_NOT_ALLOWED == audio_locations)
    {
        APPL_TRC("\t\t- Not Allowed (0x%08X)\n", GA_AUDIO_LOCATION_NOT_ALLOWED);
    }
    if (GA_AUDIO_LOCATION_FL == (audio_locations & GA_AUDIO_LOCATION_FL))
    {
        APPL_TRC("\t\t- Front Left (0x%08X)\n", GA_AUDIO_LOCATION_FL);
    }
    if (GA_AUDIO_LOCATION_FR == (audio_locations & GA_AUDIO_LOCATION_FR))
    {
        APPL_TRC("\t\t- Front Right (0x%08X)\n", GA_AUDIO_LOCATION_FR);
    }
    if (GA_AUDIO_LOCATION_FC == (audio_locations & GA_AUDIO_LOCATION_FC))
    {
        APPL_TRC("\t\t- Front Center (0x%08X)\n", GA_AUDIO_LOCATION_FC);
    }
    if (GA_AUDIO_LOCATION_LOW_FREQ_EFF_1 ==
            (audio_locations & GA_AUDIO_LOCATION_LOW_FREQ_EFF_1))
    {
        APPL_TRC
        (
            "\t\t- Low Frequency Effects 1 (0x%08X)\n",
            GA_AUDIO_LOCATION_LOW_FREQ_EFF_1
        );
    }
    if (GA_AUDIO_LOCATION_BL == (audio_locations & GA_AUDIO_LOCATION_BL))
    {
        APPL_TRC("\t\t- Back Left (0x%08X)\n", GA_AUDIO_LOCATION_BL);
    }
    if (GA_AUDIO_LOCATION_BR == (audio_locations & GA_AUDIO_LOCATION_BR))
    {
        APPL_TRC("\t\t- Back Right (0x%08X)\n", GA_AUDIO_LOCATION_BR);
    }
    if (GA_AUDIO_LOCATION_FLC == (audio_locations & GA_AUDIO_LOCATION_FLC))
    {
        APPL_TRC("\t\t- Front Left of Center (0x%08X)\n", GA_AUDIO_LOCATION_FLC);
    }
    if (GA_AUDIO_LOCATION_FRC == (audio_locations & GA_AUDIO_LOCATION_FRC))
    {
        APPL_TRC
        (
            "\t\t- Front Right of Center (0x%08X)\n",
            GA_AUDIO_LOCATION_FRC
        );
    }
    if (GA_AUDIO_LOCATION_BC == (audio_locations & GA_AUDIO_LOCATION_BC))
    {
        APPL_TRC("\t\t- Back Center (0x%08X)\n", GA_AUDIO_LOCATION_BC);
    }
    if (GA_AUDIO_LOCATION_LOW_FREQ_EFF_2 ==
            (audio_locations & GA_AUDIO_LOCATION_LOW_FREQ_EFF_2))
    {
        APPL_TRC
        (
            "\t\t- Low Frequency Effects 2 (0x%08X)\n",
            GA_AUDIO_LOCATION_LOW_FREQ_EFF_2
        );
    }
    if (GA_AUDIO_LOCATION_SL == (audio_locations & GA_AUDIO_LOCATION_SL))
    {
        APPL_TRC("\t\t- Side Left (0x%08X)\n", GA_AUDIO_LOCATION_SL);
    }
    if (GA_AUDIO_LOCATION_SR == (audio_locations & GA_AUDIO_LOCATION_SR))
    {
        APPL_TRC("\t\t- Side Right (0x%08X)\n", GA_AUDIO_LOCATION_SR);
    }
    if (GA_AUDIO_LOCATION_TFL == (audio_locations & GA_AUDIO_LOCATION_TFL))
    {
        APPL_TRC("\t\t- Top Front Left (0x%08X)\n", GA_AUDIO_LOCATION_TFL);
    }
    if (GA_AUDIO_LOCATION_TFR == (audio_locations & GA_AUDIO_LOCATION_TFR))
    {
        APPL_TRC("\t\t- Top Front Right (0x%08X)\n", GA_AUDIO_LOCATION_TFR);
    }
    if (GA_AUDIO_LOCATION_TFC == (audio_locations & GA_AUDIO_LOCATION_TFC))
    {
        APPL_TRC("\t\t- Top Front Center (0x%08X)\n", GA_AUDIO_LOCATION_TFC);
    }
    if (GA_AUDIO_LOCATION_TC == (audio_locations & GA_AUDIO_LOCATION_TC))
    {
        APPL_TRC("\t\t- Top Center (0x%08X)\n",GA_AUDIO_LOCATION_TC);
    }
    if (GA_AUDIO_LOCATION_TBL == (audio_locations & GA_AUDIO_LOCATION_TBL))
    {
        APPL_TRC("\t\t- Top Back Left (0x%08X)\n", GA_AUDIO_LOCATION_TBL);
    }
    if (GA_AUDIO_LOCATION_TBR == (audio_locations & GA_AUDIO_LOCATION_TBR))
    {
        APPL_TRC("\t\t- Top Back Right (0x%08X)\n", GA_AUDIO_LOCATION_TBR);
    }
    if (GA_AUDIO_LOCATION_TSL == (audio_locations & GA_AUDIO_LOCATION_TSL))
    {
        APPL_TRC("\t\t- Top Side Left (0x%08X)\n", GA_AUDIO_LOCATION_TSL);
    }
    if (GA_AUDIO_LOCATION_TSR == (audio_locations & GA_AUDIO_LOCATION_TSR))
    {
        APPL_TRC("\t\t- Top Side Right (0x%08X)\n", GA_AUDIO_LOCATION_TSR);
    }
    if (GA_AUDIO_LOCATION_TBC == (audio_locations & GA_AUDIO_LOCATION_TBC))
    {
        APPL_TRC("\t\t- Top Back Center (0x%08X)\n", GA_AUDIO_LOCATION_TBC);
    }
    if (GA_AUDIO_LOCATION_BFC == (audio_locations & GA_AUDIO_LOCATION_BFC))
    {
        APPL_TRC("\t\t- Bottom Front Center (0x%08X)\n", GA_AUDIO_LOCATION_BFC);
    }
    if (GA_AUDIO_LOCATION_BFL == (audio_locations & GA_AUDIO_LOCATION_BFL))
    {
        APPL_TRC("\t\t- Bottom Front Left (0x%08X)\n", GA_AUDIO_LOCATION_BFL);
    }
    if (GA_AUDIO_LOCATION_BFR == (audio_locations & GA_AUDIO_LOCATION_BFR))
    {
        APPL_TRC("\t\t- Bottom Front Right (0x%08X)\n", GA_AUDIO_LOCATION_BFR);
    }
    if (GA_AUDIO_LOCATION_FLW == (audio_locations & GA_AUDIO_LOCATION_FLW))
    {
        APPL_TRC("\t\t- Front Left Wide (0x%08X)\n", GA_AUDIO_LOCATION_FLW);
    }
    if (GA_AUDIO_LOCATION_FRW == (audio_locations & GA_AUDIO_LOCATION_FRW))
    {
        APPL_TRC("\t\t- Front Right Wide (0x%08X)\n", GA_AUDIO_LOCATION_FRW);
    }
    if (GA_AUDIO_LOCATION_LS == (audio_locations & GA_AUDIO_LOCATION_LS))
    {
        APPL_TRC("\t\t- Left Surround (0x%08X)\n", GA_AUDIO_LOCATION_LS);
    }
    if (GA_AUDIO_LOCATION_RS == (audio_locations & GA_AUDIO_LOCATION_RS))
    {
        APPL_TRC("\t\t- Right Surround (0x%08X)\n", GA_AUDIO_LOCATION_RS);
    }
    if (GA_AUDIO_LOCATION_RFU_1 == (audio_locations & GA_AUDIO_LOCATION_RFU_1))
    {
        APPL_TRC("\t\t- RFU 1 (0x%08X)\n", GA_AUDIO_LOCATION_RFU_1);
    }
    if (GA_AUDIO_LOCATION_RFU_2 == (audio_locations & GA_AUDIO_LOCATION_RFU_2))
    {
        APPL_TRC("\t\t- RFU 2 (0x%08X)\n", GA_AUDIO_LOCATION_RFU_2);
    }
    if (GA_AUDIO_LOCATION_RFU_3 == (audio_locations & GA_AUDIO_LOCATION_RFU_3))
    {
        APPL_TRC("\t\t- RFU 3 (0x%08X)\n", GA_AUDIO_LOCATION_RFU_3);
    }
    if (GA_AUDIO_LOCATION_RFU_4 == (audio_locations & GA_AUDIO_LOCATION_RFU_4))
    {
...
void appl_ga_utils_bap_display_ssf(UINT16 ssf)
{
    ...
    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_8000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_8000 & ssf))
    {
        APPL_TRC("\t\t\t\t8000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_11025 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_11025 & ssf))
    {
        APPL_TRC("\t\t\t\t11025 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_16000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_16000 & ssf))
    {
        APPL_TRC("\t\t\t\t16000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_22050 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_22050 & ssf))
    {
        APPL_TRC("\t\t\t\t22050 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_24000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_24000 & ssf))
    {
        APPL_TRC("\t\t\t\t24000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_32000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_32000 & ssf))
    {
        APPL_TRC("\t\t\t\t32000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_44100 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_44100 & ssf))
    {
        APPL_TRC("\t\t\t\t44100 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_48000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_48000 & ssf))
    {
        APPL_TRC("\t\t\t\t48000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_88200 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_88200 & ssf))
    {
        APPL_TRC("\t\t\t\t88200 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_96000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_96000 & ssf))
    {
        APPL_TRC("\t\t\t\t96000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_176400 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_176400 & ssf))
    {
        APPL_TRC("\t\t\t\t176400 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_192000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_192000 & ssf))
    {
        APPL_TRC("\t\t\t\t192000 Hz\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_384000 ==
            (GA_LTV_CODEC_SPEC_CAP_SSF_VAL_384000 & ssf))
    {
        APPL_TRC("\t\t\t\t384000 Hz\n");
    }
...
{
    APPL_TRC("0x%02X\n", sfd);
    if (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_7_5_MS ==
            (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_7_5_MS & sfd))
    {
        APPL_TRC("\t\t\t\t7.5 ms\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_10_MS ==
            (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_10_MS & sfd))
    {
        APPL_TRC("\t\t\t\t10 ms\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_7_5_MS_PREF ==
            (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_7_5_MS_PREF & sfd))
    {
        APPL_TRC("\t\t\t\t7.5 ms preferred\n");
    }

    if (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_10_MS_PREF ==
            (GA_LTV_CODEC_SPEC_CAP_SFD_VAL_10_MS_PREF & sfd))
    {
...
{
    APPL_TRC(" (0x%02X)\n", sacc);
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_1 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_1))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 1\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_2 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_2))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 2\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_3 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_3))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 3\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_4 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_4))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 4\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_5 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_5))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: \5\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_6 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_6))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 6\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_7 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_7))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 7\n");
    }
    if (GA_LTV_CODEC_SPEC_CAP_SACC_VAL_8 ==
            (sacc & GA_LTV_CODEC_SPEC_CAP_SACC_VAL_8))
    {
        APPL_TRC("\t\t\t\t\tChannel Count: 8\n");
    }
...
UINT16 appl_ga_utils_bap_get_pref_ctx(void)
{
    ...
    CONSOLE_OUT("Enter Preferred Contexts (0x): \n");
    pref_cntx = appl_ga_utils_bap_get_ctx_type();
     ...
     )
{
    ...
    if (GA_TRUE == is_this_req)
    {
        ...
        for (UINT8 index = 0U; index < data_len; index++)
        {
...
UINT8 appl_ga_utils_bap_get_choice_for_update_notify(void)
{
    ...
    CONSOLE_OUT("Enter Update/Notify: 1 - Update, 2 - Notify, 3 - Update and Notify:\n");
    CONSOLE_IN("%d", &choice);
...
UINT8 appl_ga_utils_bap_get_role(void)
{
    ...
    CONSOLE_OUT("Enter Role: 1 - Sink, 2 - Source, 3 - Source & Sink:\n");
    CONSOLE_OUT("NOTE: Role as Source & Sink is required only during PACS register\n");
    CONSOLE_IN("%d", &choice);
 ...
 *            Name: Audio Source
 * As per Appearance Values in Assigned Numbers Spec
 */
...
GA_RESULT appl_ga_register_pacs(APPL_GA_ROLE role)
{
    ...
    else if (APPL_GA_TMAP_ROLE_CT == (APPL_GA_TMAP_ROLE_CT & role))
    {
        ...
        /* BAP Audio Sink Role: C.1 */
        retval = appl_ga_utils_bap_register_pacs_using_default_values
                 (
                     role, GA_ROLE_SINK
                 );
        /* BAP Audio Source Role: C.1 */
        retval = appl_ga_utils_bap_register_pacs_using_default_values
                 (
                     role, GA_ROLE_SOURCE
                 );
    }
    else if (APPL_GA_TMAP_ROLE_BMR == (APPL_GA_TMAP_ROLE_BMR & role))
    {
        /* BAP Audio Sink Role: Mandatory */
        retval = appl_ga_utils_bap_register_pacs_using_default_values
                 (
    ...
    else if (APPL_GA_HAP_ROLE_HA == (APPL_GA_HAP_ROLE_HA & role))
    {
        ...
        /* BAP Audio Source Role: Optional */
        retval = appl_ga_utils_bap_register_pacs_using_default_values
                 (
                     role, GA_ROLE_SOURCE
                 );
    ...
    else
    {
        ...
        cap_role = appl_ga_utils_bap_get_role();
    }

    if (GA_ROLE_SINK == (GA_ROLE_SINK & cap_role))
    {
    ...
    if (GA_ROLE_SOURCE == (GA_ROLE_SOURCE & cap_role))
    {
        retval = appl_ga_utils_bap_register_pacs_using_runtime_values
                 (
                     role, GA_ROLE_SOURCE
          ...
          )
{
    ...
    context_type = 0U;
    audio_loc = 0U;
    is_oring_req = GA_FALSE;
    k = 0U;

    if (GA_ROLE_SOURCE == cap_role)
    {
        APPL_TRC("Registering Source PAC:\n");
    }
    else if (GA_ROLE_SINK == cap_role)
    {
        APPL_TRC("Registering Sink PAC:\n");
    }
    ...
    for (index = 0U; index < count; index++)
    {
        /* Reseting the CSC */
        /*
         * Case: For 2 Instance, 1 Record each
         * CSC will not be reset after first instance and due to
         * csc_set_count = 1 (1 Record), CSC will not get reset before taking
         * input for 2nd instance's record.
         */
        GA_mem_set
        (
            &csc,
        ...
        if (1U < csc_set_count)
        {
            CONSOLE_OUT("Do you want the CSC to be Ored into a single record?\n");
            CONSOLE_OUT("1. Yes\n2. No\n");
            CONSOLE_IN("%d", &choice);
        }
        ...
        if (GA_ROLE_SOURCE == cap_role)
        {
            cap_count = local_pacs.pacs_src_cap_count;
        }
        else if (GA_ROLE_SINK == cap_role)
        {
            cap_count = local_pacs.pacs_snk_cap_count;
        }
        else
        {
            APPL_INF("Invalid GA cap_role: 0x%02X\n", cap_role);
            return retval;
        }
        ...
        for (j = 0U; j < csc_set_count; j++)
        {
            ...
            {
                /*
                 * Reset is_oring_req to GA_FALSE
                 * 2 Instance of PAC
                 * Case 1: 1st PAC instance have single record with multiple
                 *         sets, hence is_oring_req is GA_TRUE.
                 *         So, for 2nd PAC instance having multiple records
                 *         will also have is_oring_req set to GA_TRUE, which
                 *         should have been GA_FALSE in this case.
                 * Case 2: 1st PAC instance have single record with single set,
                 *         hence is_oring_req is not in use but gets set to
                 *         GA_TRUE. So, for 2nd PAC instance having multiple
                 *         records will also have is_oring_req set to GA_TRUE,
                 *         which should have been GA_FALSE in this case.
                 */
                is_oring_req = GA_FALSE;
                GA_mem_set
                (
            ...
            {
                is_oring_req = GA_TRUE;
                /* For ORed value, there will be one PAC record */
                k = 0U;
            }
            /* Fetch the previously added Count, Continue from there */
            if (GA_ROLE_SOURCE == cap_role)
            {
                cap = &local_pacs.pacs_src_cap[cap_count].cap[k];
            }
            else if (GA_ROLE_SINK == cap_role)
            {
                cap = &local_pacs.pacs_snk_cap[cap_count].cap[k];
            }
                              ...
                              ))
            {
                ...
                if (GA_ROLE_SOURCE == cap_role)
                {
                    local_pacs.pacs_src_cap[cap_count].lc3_cs_cap[k].supported_sf =
                        csc.supported_sf;
                    local_pacs.pacs_src_cap[cap_count].lc3_cs_cap[k].supported_fd =
                        csc.supported_fd;
                    local_pacs.pacs_src_cap[cap_count].lc3_cs_cap[k].supported_acc =
                        csc.supported_acc;
                    local_pacs.pacs_src_cap[cap_count].lc3_cs_cap[k].supported_opcf =
                        csc.supported_opcf;
                    local_pacs.pacs_src_cap[cap_count].lc3_cs_cap[k].supported_mcfpSDU =
                        csc.supported_mcfpSDU;

                    if (GA_TRUE != is_oring_req)
                    {
                        /* Update the Number of Records per Instance */
                        local_pacs.pacs_src_cap[cap_count].cap_count_per_instance++;
                    }
                }
                else if (GA_ROLE_SINK == cap_role)
                {
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[k].supported_sf =
                        csc.supported_sf;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[k].supported_fd =
                        csc.supported_fd;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[k].supported_acc =
                        csc.supported_acc;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[k].supported_opcf =
                        csc.supported_opcf;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[k].supported_mcfpSDU =
                        csc.supported_mcfpSDU;

                    if (GA_TRUE != is_oring_req)
                    {
                        /* Update the Number of Records per Instance */
                        local_pacs.pacs_snk_cap[cap_count].cap_count_per_instance++;
                    }
                }
            }
            else
        ...
        if (GA_TRUE == is_oring_req)
        {
            /* In this case there will be 1 record with ORed value in csc cap */
            if (GA_ROLE_SOURCE == cap_role)
            {
                /* Update the Number of Records per Instance */
                local_pacs.pacs_src_cap[cap_count].cap_count_per_instance++;
        ...
        if (GA_ROLE_SOURCE == cap_role)
        {
            cap = &local_pacs.pacs_src_cap[index].cap[0U];
        }
        else if (GA_ROLE_SINK == cap_role)
        {
            cap = &local_pacs.pacs_snk_cap[index].cap[0U];
        }

        /*
         * k refers to csc_set_count
         * If is_oring_req flag is enabled, then inspite of user input for
         * csc_set_count, there will be only one record with all the supported
         * values. [In this state k = 0, so increment k by 1]
         * If is_oring_req flag is disabled, then k will be same as user input
         * for csc_set_count. [In this state k = (j - 1) = (csc_set_count - 1)]
         * [So, increment k by 1].
         */
        k++;
        ...
        cap->pref_audio_contexts = appl_ga_utils_bap_get_pref_ctx();
        ...
        APPL_TRC("Audio Capability Record ID: %d\n", record_id);

        if (GA_SUCCESS == retval)
        {
            if (GA_ROLE_SOURCE == cap_role)
            {
                local_pacs.src_record_id[index] = record_id;
                local_pacs.pacs_src_cap_count++;
            }
            else if (GA_ROLE_SINK == cap_role)
            {
                local_pacs.snk_record_id[index] = record_id;
                local_pacs.pacs_snk_cap_count++;
            }
        }
    }
    ...
    if (GA_SUCCESS == retval)
    {
        if (GA_ROLE_SINK == cap_role)
        {
             ...
             */
            context_type |= GA_CONTEXT_TYPE_UNSPECIFIED;
          ...
          )
{
    ...
    for (index = 0U; index < count; index++)
    {
        ...
        for (j = 0U; j < csc_set_count; j++)
        {
            ...
            if (APPL_GA_TMAP_ROLE_CT == (APPL_GA_TMAP_ROLE_CT & role))
            {
                /* TMAP Role: CT, Shall be one of
                 * 3: 16_1,
                 * 4: 16_2,
                 * 7: 32_1,
                 * 8: 32_2
            ...
            else if (APPL_GA_TMAP_ROLE_UMR == (APPL_GA_TMAP_ROLE_UMR & role))
            {
                ...
                ))
            {
                ...
                {
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[j].supported_sf =
                        csc.supported_sf;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[j].supported_fd =
                        csc.supported_fd;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[j].supported_acc =
                        csc.supported_acc;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[j].supported_opcf =
                        csc.supported_opcf;
                    local_pacs.pacs_snk_cap[cap_count].lc3_cs_cap[j].supported_mcfpSDU =
                        csc.supported_mcfpSDU;
        ...
        {
            /*
             * The Call Terminal (CT) role is defined for headset type
             * devices in telephony or VoIP applications. Typical devices
             * implementing the CT role include wireless headsets,
             * speakers, and microphones that participate in
             * conversational audio.
             */
            cap->pref_audio_contexts = GA_CONTEXT_TYPE_CONVERSATIONAL;
        }
        else if (APPL_GA_HAP_ROLE_HA == (APPL_GA_HAP_ROLE_HA & role))
        {
            cap->pref_audio_contexts = GA_CONTEXT_TYPE_CONVERSATIONAL |
        ...
        {
            cap->pref_audio_contexts = GA_CONTEXT_TYPE_MEDIA;
        }
        else if (APPL_GA_TMAP_ROLE_BMR == (APPL_GA_TMAP_ROLE_BMR & role))
        {
            cap->pref_audio_contexts = GA_CONTEXT_TYPE_MEDIA;
    ...
    if (GA_SUCCESS == retval)
    {
        if (GA_ROLE_SINK == cap_role)
        {
            ...
            else if (APPL_GA_HAP_ROLE_HA == (APPL_GA_HAP_ROLE_HA & role))
            {
                ...
                context_type = GA_CONTEXT_TYPE_UNSPECIFIED |
                               GA_CONTEXT_TYPE_CONVERSATIONAL |
                               GA_CONTEXT_TYPE_MEDIA | GA_CONTEXT_TYPE_LIVE;
            }
            else if (APPL_GA_TMAP_ROLE_UMR == (APPL_GA_TMAP_ROLE_UMR & role))
            {
                context_type = GA_CONTEXT_TYPE_UNSPECIFIED |
            ...
            if (APPL_GA_TMAP_ROLE_CT == (APPL_GA_TMAP_ROLE_CT & role))
            {
                 ...
                 * conversational audio.
                 */
                context_type = GA_CONTEXT_TYPE_CONVERSATIONAL;
            }
            else if (APPL_GA_HAP_ROLE_HA == (APPL_GA_HAP_ROLE_HA & role))
            {
                /*
...
{
    appl_ga_ucs_register_ascs(role);
}
          ...
          )
{
    ...
    if (GA_ROLE_SINK == cap_role)
    {
        for (index = 0U; index < APPL_MAX_SINK_PAC_RECORDS; index++)
        {
            if (record_id == local_pacs.snk_record_id[index])
            {
                local_pacs.pacs_snk_cap[index].cap_count_per_instance = 0U;

                for (j = 0U; j < APPL_MAX_PAC_RECORDS_IN_SINGLE_INST; j++)
                {
                    /* This is the PAC Record Instance we are interested in changing */
                    GA_mem_set
                    (
                        &local_pacs.pacs_snk_cap[index].cap[j],
                        0x00U,
                        sizeof(GA_AUDIO_CAP)
                    );
                    GA_mem_set
                    (
                        &local_pacs.pacs_snk_cap[index].lc3_cs_cap[j],
                        0x00U,
                        sizeof(GA_LC3_CODEC_SPECIFIC_CAP)
                    );
                }
    ...
    {
        for (index = 0U; index < APPL_MAX_SOURCE_PAC_RECORDS; index++)
        {
            local_pacs.pacs_src_cap[index].cap_count_per_instance = 0U;

            if (record_id == local_pacs.src_record_id[index])
            {
                local_pacs.pacs_src_cap[index].cap_count_per_instance = 0U;
                ...
                for (j = 0U; j < APPL_MAX_PAC_RECORDS_IN_SINGLE_INST; j++)
                {
                    ...
                    GA_mem_set
                    (
                        &local_pacs.pacs_src_cap[index].cap[j],
                        0x00U,
                        sizeof(GA_AUDIO_CAP)
                    );
                    GA_mem_set
                    (
                        &local_pacs.pacs_src_cap[index].lc3_cs_cap[j],
                        0x00U,
                        sizeof(GA_LC3_CODEC_SPECIFIC_CAP)
                    );
                }
    ...
    if ((APPL_MAX_SINK_PAC_RECORDS == index) && (GA_ROLE_SINK == cap_role))
    {
        return GA_FAILURE;
    }
    else if ((APPL_MAX_SOURCE_PAC_RECORDS == index) && (GA_ROLE_SOURCE == cap_role))
    {
        return GA_FAILURE;
    }
    ...
    for (j = 0U; j < csc_set_count; j++)
    {
        ...
        if (GA_ROLE_SOURCE == cap_role)
        {
            cap = &local_pacs.pacs_src_cap[index].cap[k];
        }
        else if (GA_ROLE_SINK == cap_role)
        {
            cap = &local_pacs.pacs_snk_cap[index].cap[k];
        }
        else
        {
            continue;
            ...
            ))
        {
            ...
            if (GA_ROLE_SOURCE == cap_role)
            {
                local_pacs.pacs_src_cap[index].lc3_cs_cap[k].supported_sf =
                    csc.supported_sf;
                local_pacs.pacs_src_cap[index].lc3_cs_cap[k].supported_fd =
                    csc.supported_fd;
                local_pacs.pacs_src_cap[index].lc3_cs_cap[k].supported_acc =
                    csc.supported_acc;
                local_pacs.pacs_src_cap[index].lc3_cs_cap[k].supported_opcf =
                    csc.supported_opcf;
                local_pacs.pacs_src_cap[index].lc3_cs_cap[k].supported_mcfpSDU =
                    csc.supported_mcfpSDU;
            ...
            {
                local_pacs.pacs_snk_cap[index].lc3_cs_cap[k].supported_sf =
                    csc.supported_sf;
                local_pacs.pacs_snk_cap[index].lc3_cs_cap[k].supported_fd =
                    csc.supported_fd;
                local_pacs.pacs_snk_cap[index].lc3_cs_cap[k].supported_acc =
                    csc.supported_acc;
                local_pacs.pacs_snk_cap[index].lc3_cs_cap[k].supported_opcf =
                    csc.supported_opcf;
                local_pacs.pacs_snk_cap[index].lc3_cs_cap[k].supported_mcfpSDU =
                    csc.supported_mcfpSDU;
          ...
          )
{
    ...
    else
    {
        ...
        {
            /*
             * Device is already present. Reuse the conn_dev_index and
             * update handle
             */
            conn_dev[index].conn_handle = handle;
        }
        else if (GA_SUCCESS == appl_ga_utils_get_free_conn_device(&index))
        {
...
GA_RESULT appl_ga_utils_remove_conn_device(UINT8 index)
{
    ...
    else
    {
        ...
        else
        {
            ...
            conn_dev[index].conn_handle = INVALID_CONN_HANDLE;
        }
    }
...
void appl_ga_utils_reset_dev_manager(void)
{
    ...
    APPL_TRC("Resetting the device manager...\n");
    for (index = 0U; index < MAX_CONN_DEVICES; index++)
    {
        GA_mem_set(&conn_dev[index], 0x00U, sizeof(CONN_DEVICES));
        conn_dev[index].conn_handle = INVALID_CONN_HANDLE;
...
void appl_ga_utils_display_all_conn_device(void)
{
    ...
    for (index = 0U; index < MAX_CONN_DEVICES; index++)
    {
        if (GA_BRR_DEV_ADDR_IS_NON_ZERO(conn_dev[index].device.bd_addr))
        {
            ...
            if (INVALID_CONN_HANDLE == conn_dev[index].conn_handle)
            {
                APPL_TRC
                (
                    "Connection Handle (Disconnected): 0x%04X\n",
            ...
            else
            {
                APPL_TRC
                (
                    "Connection Handle (Connected): 0x%04X\n",
                    conn_dev[index].conn_handle
                );
            }
            APPL_TRC("Initiator: 0x%02X\n", conn_dev[index].isInitiator);

            if (GA_TRUE == conn_dev[index].is_sm)
            {
                /* Display the SM Details */
                APPL_TRC
                (
                    "Set Member: Yes\n"
                );
                APPL_TRC("\tSet SIRK: Type: 0x%02X, Value: ", conn_dev[index].sm.sirk[0]);
                appl_dump_bytes(&conn_dev[index].sm.sirk[1], CSIP_SIRK_LEN);
                APPL_TRC("\tSet Size: %d\n", conn_dev[index].sm.size);
                APPL_TRC("\tSet Lock: %d\n", conn_dev[index].sm.lock);
                APPL_TRC("\tSet Rank: %d\n", conn_dev[index].sm.rank);

                if (CSIP_SIRK_TYPE_ENCRYPTED == conn_dev[index].sm.sirk[0U])
                {
                    appl_dump_bytes(&conn_dev[index].decsirk[0U], CSIP_SIRK_LEN);
                }
            }
            else
            {
...
UINT8 appl_ga_utils_get_num_of_conn_device(void)
{
    ...
    {
        if ((GA_BRR_DEV_ADDR_IS_NON_ZERO(conn_dev[index].device.bd_addr)) &&
            (INVALID_CONN_HANDLE != conn_dev[index].conn_handle))
        {
            num_of_conn_dev++;
        }
    }

    return num_of_conn_dev;
}
...
GA_RESULT appl_ga_utils_get_free_conn_device(UINT8 * index)
{
    ...
    for (i = 0U; i < MAX_CONN_DEVICES; i++)
    {
        ...
        if ((!GA_IS_NON_ZERO_ENDPOINT_ADDR(conn_dev[i].device.bd_addr)) &&
            (INVALID_CONN_HANDLE == conn_dev[i].conn_handle))
        {
            *index = i;
            return GA_SUCCESS;
        }
...
{
    GA_mem_copy(&conn_dev[conn_dev_index].cas_svc_info, cas_svc_info, sizeof(GA_BRR_SVC_INFO));
}
...
{
    conn_dev[conn_dev_index].is_sm = GA_TRUE;
    conn_dev[conn_dev_index].sm = sm;
}
...
{
    conn_dev[conn_dev_index].set_handle = set_handle;
}
...
{
    GA_mem_copy(&conn_dev[conn_dev_index].key, key, 16U);
}
...
{
    conn_dev[conn_dev_index].decSirkOngoing = status;
}
...
{
    if (GA_TRUE == conn_dev[conn_dev_index].decSirkOngoing)
    {
        GA_mem_copy
        (
            &conn_dev[conn_dev_index].decsirk,
            &sirk[0U],
            CSIP_SIRK_LEN
        );
    }
...
{
    GA_mem_copy(sm, &conn_dev[conn_dev_index].sm, sizeof(GA_SET_MEMBER));
}
     ...
     )
{
    switch(char_uuid)
    {
        case GA_CHAR_CSIS_SIRK:
            GA_mem_copy
            (
                conn_dev[conn_dev_index].sm.sirk,
                sm_data,
                (1U + CSIP_SIRK_LEN)
            );

            if (CSIP_SIRK_TYPE_PLAIN_TEXT == sm_data[0U])
            {
                GA_mem_set
                (
                    conn_dev[conn_dev_index].decsirk,
        ...
        case GA_CHAR_CSIS_SIZE:
            conn_dev[conn_dev_index].sm.size = *sm_data;
            break;

        case GA_CHAR_CSIS_LOCK:
            conn_dev[conn_dev_index].sm.lock = *sm_data;
            break;

        case GA_CHAR_CSIS_RANK:
            conn_dev[conn_dev_index].sm.rank = *sm_data;
            break;

        default:
            APPL_ERR("Unhandled CHAR UUID !\n");
    }
...
{
    *lock_req = conn_dev[conn_dev_index].lockReqOngoing;
}
...
{
    conn_dev[conn_dev_index].lockReqOngoing = lock_req;
}
...
{
    /* Copy the key */
    GA_mem_copy(key, &conn_dev[conn_dev_index].key[0U], 16U);
}
...
void appl_ga_utils_fetch_sm_device_sirk_decrypting(UINT8 * conn_dev_index)
{
    ...
    for (index = 0U; index < MAX_CONN_DEVICES; index++)
    {
        if (GA_TRUE == conn_dev[index].decSirkOngoing)
        {
            break;
        }
    }

    *conn_dev_index = index;
...
{
    *set_handle = (conn_dev[conn_dev_index].set_handle);
...
{
    GA_mem_copy(cas_svc_info, &conn_dev[conn_dev_index].cas_svc_info, sizeof(GA_BRR_SVC_INFO));
...
{
    conn_dev[index].conn_handle = conn_handle;
          ...
          )
{
    ...
    if (GA_SUCCESS == retval)
    {
        ...
        if (GA_SUCCESS == retval && NULL != capab)
        {
            ...
            {
                /* Fetch the Capability Record ID */
                record_id = capab->record_id;
     ...
     )
{
    ...
    UINT8          metadata_len;
    UINT8          i;
    GA_AUDIO_CAP   snk_cap[APPL_MAX_SINK_PAC_RECORDS] = {0};
    GA_AUDIO_CAP   src_cap[APPL_MAX_SOURCE_PAC_RECORDS] = {0};
    ...
    if (GA_ROLE_SINK == role)
    {
        ...
        if (APPL_GA_INIT_STATUS_GA == ga_init_status)
        {
            /* Find the index from the Record ID */
            for (i = 0U; i < APPL_MAX_SINK_PAC_RECORDS; i++)
            {
                if (record_id == remote_pacs[index].pacs.snk_record_id[i])
                {
                    cap_count = i;
                    break;
                }
            ...
            if ((APPL_MAX_SINK_PAC_RECORDS == i) && (GA_FALSE == to_update))
            {
                /* This means there is new record to add */
                cap_count = remote_pacs[index].pacs.pacs_snk_cap_count;
            }

            if (cap_count != APPL_MAX_SINK_PAC_RECORDS)
            {
                remote_pacs[index].pacs.pacs_snk_cap[cap_count].cap_count_per_instance = 0U;
                cap_count_per_instance = 0U;
                audio_cap = &remote_pacs[index].pacs.pacs_snk_cap[cap_count].cap[cap_count_per_instance];
                remote_pacs[index].pacs.snk_record_id[cap_count] = record_id;
            }
            else
            {
                return;
    ...
    else if (GA_ROLE_SOURCE == role)
    {
        ...
        {
            /* Find the index from the Record ID */
            for (i = 0U; i < APPL_MAX_SOURCE_PAC_RECORDS; i++)
            {
                if (record_id == remote_pacs[index].pacs.src_record_id[i])
                {
                    cap_count = i;
                    break;
                }
            ...
            {
                /* This means there is new record to add */
                cap_count = remote_pacs[index].pacs.pacs_src_cap_count;
            }

            if (cap_count != APPL_MAX_SOURCE_PAC_RECORDS)
            {
                remote_pacs[index].pacs.pacs_src_cap[cap_count].cap_count_per_instance = 0U;
                cap_count_per_instance = 0U;
                audio_cap = &remote_pacs[index].pacs.pacs_src_cap[cap_count].cap[cap_count_per_instance];
                remote_pacs[index].pacs.src_record_id[cap_count] = record_id;
            }
            else
            {
                return;
    ...
    APPL_TRC("Capability Record ID: %d\n", record_id);
    ...
    for (i = 0U; i < num_of_pacs_records; i++)
    {
        ...
        {
            APPL_TRC("Source PAC Record Instance Index: 0x%02X\n", cap_count);
            APPL_TRC
            (
                "Codec Specific Capabilities Index: 0x%02X\n",
                remote_pacs[index].pacs.pacs_src_cap[cap_count].cap_count_per_instance
            );
            remote_pacs[index].pacs.pacs_src_cap[cap_count].cap_count_per_instance++;
            cap++;
        }
        ...
        {
            APPL_TRC("Sink PAC Record Instance Index: 0x%02X\n", cap_count);
            APPL_TRC
            (
                "Codec Specific Capabilities Index: 0x%02X\n",
                remote_pacs[index].pacs.pacs_snk_cap[cap_count].cap_count_per_instance
            );
            remote_pacs[index].pacs.pacs_snk_cap[cap_count].cap_count_per_instance++;
            cap++;
        }
    ...
    if (APPL_GA_INIT_STATUS_GA == ga_init_status)
    {
        if ((GA_ROLE_SINK == role) && (GA_FALSE == to_update))
        {
            remote_pacs[index].pacs.pacs_snk_cap_count++;
        }
        else if ((GA_ROLE_SOURCE == role) && (GA_FALSE == to_update))
        {
            remote_pacs[index].pacs.pacs_src_cap_count++;
        }
    }
...
void appl_ga_utils_connect(UCHAR mode, void * param)
{
    ...
    if (0x01 == mode)
    {
        APPL_GA_LE_EXT_CONN_PARAMS *e_param =
            (APPL_GA_LE_EXT_CONN_PARAMS *)param;

        CONSOLE_OUT("Initiating LE Extended Connection...\n");

        retval = BT_hci_le_extended_create_connection
                 (
                     e_param->init_filr_policy,
                     e_param->own_addr_type,
                     e_param->peer_addr_type,
                     e_param->peer_addr,
                     e_param->init_phy,
                     e_param->scan_interval,
                     e_param->scan_window,
                     e_param->conn_interval_min,
                     e_param->conn_interval_max,
                     e_param->conn_latency,
                     e_param->supervision_timeout,
                     e_param->min_ce_len,
                     e_param->max_ce_len
                 );
    }
    ...
    {
        APPL_GA_LE_CONN_PARAMS* n_param =
            (APPL_GA_LE_CONN_PARAMS*)param;
        
        CONSOLE_OUT("Initiating LE Connection...\n");

        retval = BT_hci_le_create_connection
                 (
                     n_param->scan_interval,
                     n_param->scan_window,
                     n_param->init_filr_policy,
                     n_param->peer_addr_type,
                     n_param->peer_addr,
                     n_param->own_addr_type,
                     n_param->conn_interval_min,
                     n_param->conn_interval_max,
                     n_param->conn_latency,
                     n_param->supervision_timeout,
                     n_param->max_ce_len,
                     n_param->min_ce_len
                 );
    }
...
void appl_ga_utils_bap_parse_and_display_ase_state(UCHAR ase_state)
{
    switch (ase_state)
    {
    case GA_ASE_STATE_IDLE:
        APPL_TRC("Idle");
        break;

    case GA_ASE_STATE_CODEC_CONF:
        APPL_TRC("Codec Configured");
        break;

    case GA_ASE_STATE_QOS_CONF:
        APPL_TRC("QoS Configured");
        break;

    case GA_ASE_STATE_ENABLING:
        APPL_TRC("Enabling");
        break;

    case GA_ASE_STATE_STREAMING:
        APPL_TRC("Streaming");
        break;

    case GA_ASE_STATE_DISABLING:
        APPL_TRC("Disabling");
        break;

    case GA_ASE_STATE_RELEASING:
        APPL_TRC("Releasing");
        break;
...
void appl_ga_utils_config_brr_escan(void)
{
    ...
    /* Fetch own address and type for BC Sink - Current Role */
    appl_ga_utils_fetch_own_address_and_type(&device, SET_HANDLE_CONNECTION);

    /* Update own address and type for ESCAN params */
    escan_params.own_addr_type = device.bd_type;

#ifndef APPL_GA_USE_CONFIG_FILE_FOR_INPUT
    /* TODO: Take input for all other members */
#endif /* APPL_GA_USE_CONFIG_FILE_FOR_INPUT */

    retval = ga_brr_config_escan_params_pl(&escan_params);
    APPL_TRC("Retval - 0x%04X\n", retval);
}

void appl_ga_utils_config_brr_eadv(void)
{
    GA_BRR_EXTENDED_ADV_PARAMS bc_eadv_params;
    GA_RESULT retval;
    GA_ENDPOINT device;

    /* Initialize default broadcast adv parameters */
    bc_eadv_params.adv_event_properties = 0x00;
    bc_eadv_params.adv_filter_policy = 0x00;
    bc_eadv_params.adv_tx_power = 0x00;
    bc_eadv_params.duration = 0x00;
    bc_eadv_params.frag_pref = 0x01;
    bc_eadv_params.max_ext_adv_evts = 0x00;
    bc_eadv_params.own_addr_type = 0x00;
    BT_mem_set(&bc_eadv_params.peer_addr[0], 0, BT_BD_ADDR_SIZE);
    bc_eadv_params.peer_addr_type = 0x00;
    bc_eadv_params.pri_adv_channel_map = 0x07;
    bc_eadv_params.pri_adv_interval_max = 0x00000020;
    bc_eadv_params.pri_adv_interval_min = 0x00000020;
    bc_eadv_params.pri_adv_phy = 0x01;
    bc_eadv_params.scan_req_nfy_enable = 0x00;
    bc_eadv_params.sec_adv_max_skip = 0x00;
    bc_eadv_params.sec_adv_phy = 0x01;
    BT_mem_set(&bc_eadv_params.own_addr[0], 0, BT_BD_ADDR_SIZE);

    /* Fetch own address and type for broadcast */
    appl_ga_utils_fetch_own_address_and_type
    (
        &device,
        SET_HANDLE_BROADCAST
    );

    /* Update own address and type in EADV params */
    bc_eadv_params.own_addr_type = device.bd_type;
    GA_mem_copy
    (
        &bc_eadv_params.own_addr[0U],
        &device.bd_addr[0U],
        GA_BD_ADDR_SIZE
    );

    /* This case, the Random Address will be set with the controller
     * as part of a sequence called during BC Src EA Advertising.
     */

    retval = ga_brr_config_eadv_params_pl(&bc_eadv_params);
    APPL_TRC("Retval - 0x%04X\n", retval);
     ...
     )
{
    ...
    for (i = 0U; i < 2U; i++)
    {
        /* Update the own_addr_info for the set_handle */
        if (adv_set_handle == own_addr_info[i].set_handle)
        {
            GA_COPY_ENDPOINT(&own_addr_info[i].device, &device);
            /* own_addr_info[i].set_handle = adv_set_handle; */
            break;
        }
    }
    ...
    if (2U == i)
    {
        /* If the own_addr_info is not present, then its a new entry */
        for (i = 0U; i < 2U; i++)
        {
            if (0U == own_addr_info[i].set_handle)
            {
                GA_COPY_ENDPOINT(&own_addr_info[i].device, &device);
                own_addr_info[i].set_handle = adv_set_handle;
                break;
...
void appl_ga_utils_fetch_own_address_and_type(GA_ENDPOINT * device, UINT8 adv_set_handle)
{
    UINT8 i;
    ...
    for (i = 0U; i < 2U; i++)
    {
        if (adv_set_handle == own_addr_info[i].set_handle)
        {
            GA_COPY_ENDPOINT(device, &own_addr_info[i].device);
            break;
        }
    }
}
...
GA_RESULT appl_ga_utils_enable_legacy_advertise(UINT8 advertising_enable)
{
    ...
    /* Initialize */
    appl_adv_mode = APPL_HCI_MODE_LEGACY;
    retval = GA_SUCCESS;

    advertising_interval_min = 0x0020U;
    advertising_interval_max = 0x0020U;
    advertising_type = 0x00U;
    own_addr_type = 0x00U;
    peer_addr_type = 0x00U;
    GA_mem_set
    (
        &peer_addr[0U],
        0x00U,
    ...
    advertising_channel_map = 0x07U;
    advertising_filter_policy = 0x00U;

    /* Fetch own address and type */
    appl_ga_utils_fetch_own_address_and_type(&device, SET_HANDLE_CONNECTION);

    /* Update own address and type for legacy advertising */
    own_addr_type = device.bd_type;

    if (advertising_enable)
    {
        if (APPL_GA_ADV_INVALID == is_adv_enabled)
        {
            APPL_TRC("BT_hci_le_set_advertising_parameters\n");
...
GA_RESULT appl_ga_utils_enable_extended_advertise(UINT8 enable)
{
    ...
    if (APPL_HCI_MODE_LEGACY == appl_adv_mode)
    {
        return GA_FAILURE;
    }

    appl_adv_mode = APPL_HCI_MODE_EXTENDED;
    ...
    if (enable)
    {
        if (APPL_GA_ADV_INVALID == is_adv_enabled)
        {
            ...
            /* Fetch own address and type for connection */
            appl_ga_utils_fetch_own_address_and_type
            (
                &device,
            ...
            /* Update own address and type for connection */
            eadv_params.own_addr_type = device.bd_type;
            ...
            if (BD_ADDR_TYPE_RANDOM == eadv_params.own_addr_type)
            {
...
void appl_ga_utils_update_cap_announcement_type_in_adv()
{
    UINT8 type;

#if ((defined APPL_INIT_AUTOMATE_SERVER_SINK) || (defined APPL_GA_USE_CONFIG_FILE_FOR_INPUT))
    type = CAS_TARGETED_ANNOUNCEMENT;
#else /* ((defined APPL_INIT_AUTOMATE_SERVER_SINK) || (defined APPL_GA_USE_CONFIG_FILE_FOR_INPUT)) */
    type = appl_ga_utils_get_cap_announcement_type();
#endif /* ((defined APPL_INIT_AUTOMATE_SERVER_SINK) || (defined APPL_GA_USE_CONFIG_FILE_FOR_INPUT)) */
    appl_ga_gap_adv_data.data[7U] = type;
}

/* Get the CAP Annoucement Type */
UINT8 appl_ga_utils_get_cap_announcement_type()
{
    int choice;
    UINT8 type;

    CONSOLE_OUT("Enter the CAP Announcement Type\n");
    CONSOLE_OUT("1. General\n2. Targeted\n");
    CONSOLE_IN("%d", &choice);
    if (1 == choice)
    {
        type = CAS_GENERAL_ANNOUNCEMENT;
    }
    else
    {
        type = CAS_TARGETED_ANNOUNCEMENT;
    ...
    /* TODO: Do this automatically based on the INAP/RAP mode */
...
void appl_ga_utils_set_adv_data_for_current_tmap_role(APPL_GA_ROLE tmap_role)
{
     ...
     */
    if ((TMAP_ROLE_CT & tmap_role) || (TMAP_ROLE_UMR & tmap_role) ||
        (TMAP_ROLE_BMR & tmap_role))
    {
        /**
         * VCP Announcement
         * Service Data 16 bit UUID:
        ...
        (TMAP_ROLE_BMR & tmap_role))
    {
        ...
        /* Use this for giving run time different values,
         * appl_ga_utils_get_cap_announcement_type();
         */
        marker++;
    }
     ...
     )
{
    ...
    if (APPL_GA_HAP_ROLE_HA & hap_role)
    {
         ...
         *                            Announcement Type: 0x01U (CAS_TARGETED_ANNOUNCEMENT)
         *
         * 0x04U, 0x16U, 0x53U, 0x18U, 0x00U/0x01U,
         */
        ...
        marker += 2U;
        appl_ga_gap_adv_data_hap.data[marker] = CAS_GENERAL_ANNOUNCEMENT;
        /* Use this for giving run time different values,
         * appl_ga_utils_get_cap_announcement_type();
         */
        marker++;
        ...
        if ((0x00U == (hap_features & 0x03U)) &&
            (sizeof(appl_ga_rsi) == appl_ga_rsilen))
        {
            /**
             * CSIP Announcement
             * Service Data 16 bit UUID:
        ...
        marker += 2U;
        appl_ga_gap_adv_data_hap.data[marker] = BAP_ASCS_GENERAL_ANNOUNCEMENT;
        marker++;
        /* Fetching local PACS info to pack available audio contexts */
        appl_ga_utils_bap_fetch_local_pacs(&local_pacs_info);
        GA_PACK_LE_2_BYTE_VAL
...
{
    *rsilen = appl_ga_rsilen;
    GA_mem_copy(rsi, appl_ga_rsi, *rsilen);
}

void appl_ga_utils_set_cs_rsi(UCHAR* rsi, UINT16 rsilen)
{
    if ((NULL != rsi) && (6U == rsilen))
    {
        GA_mem_copy(appl_ga_rsi, rsi, rsilen);
        appl_ga_rsilen = (UINT8)rsilen;
    }
}

void appl_ga_utils_add_cs_info_to_advdata(void)
{
    APPL_GA_GAP_ADV_DATA * adv_data;
    UINT8 marker;
    static UINT8 starter = 0;

    if (6U == appl_ga_rsilen)
    {
        /* Get the current adv data */
        adv_data = appl_ga_utils_reference_advdata_for_current_role();

        if (0 == starter)
        {
            starter = adv_data->datalen;
        }

        /* Set marker to initial value */
        marker = starter;

        /* Update the RSI */
        adv_data->data[marker] = 0x07U;
        marker++;
        adv_data->data[marker] = GA_ADTYPE_RSI;
        marker++;
        GA_mem_copy(&adv_data->data[marker], appl_ga_rsi, 6U);
        marker += 6U;

        adv_data->datalen = marker;
    }
...
APPL_GA_GAP_ADV_DATA * appl_ga_utils_reference_advdata_for_current_role(void)
{
    ...
    {
        adv_data = &appl_ga_gap_adv_data_tmap;
    }
    else if ((APPL_GA_HAP_ROLE_HA & ga_role) || (APPL_GA_HAP_ROLE_HAUC & ga_role) ||
             (APPL_GA_HAP_ROLE_HARC & ga_role))
    {
        adv_data = &appl_ga_gap_adv_data_hap;
    }
    else
    {
        adv_data = &appl_ga_gap_adv_data;
    }
     ...
     )
{
             ...
             (APPL_GA_HAP_ROLE_HARC & ga_role))
    {
         ...
         */
        if ((APPL_GA_HAP_ROLE_HA & ga_role) && (0x00U == own_addr_type))
        {
    ...
    {
        /*
         * Bytes 13-16 refers to BAP Available Audio Context.
         * Update the Available Audio Context
         */
        marker = 13U;
        /* Fetching local PACS info to pack available audio contexts */
        appl_ga_utils_bap_fetch_local_pacs(&local_pacs_info);
        GA_PACK_LE_2_BYTE_VAL
        (
            &appl_ga_gap_adv_data.data[marker],
            local_pacs_info.record.avail_sink_contexts
        );
        marker += 2U;
        GA_PACK_LE_2_BYTE_VAL
...
GA_RESULT appl_ga_utils_enable_legacy_scan(UINT8 scan_enable)
{
    ...
    if (APPL_HCI_MODE_EXTENDED == appl_scan_mode)
    {
        return GA_FAILURE;
    }

    /* Initialize */
    appl_scan_mode = APPL_HCI_MODE_LEGACY;
    le_scan_type = 0x00U;
    le_scan_interval = 0x00A0;
    le_scan_window = 0x00A0;
    own_addr_type = 0x00U;
    scan_filter_policy = 0x00U;
    ...
    if (scan_enable)
    {
        if (APPL_GA_SCAN_INVALID == is_scan_enabled)
        {
            ...
            appl_ga_utils_hci_clear_la_db();

            appl_ga_utils_fetch_own_address_and_type(&device, SET_HANDLE_CONNECTION);

            own_addr_type = device.bd_type;

            APPL_TRC("BT_hci_le_set_scan_parameters\n");
...
GA_RESULT appl_ga_utils_enable_extended_scan(GA_BRR_EXTENDED_SCAN_PARAMS escan_params)
{
    ...
    if (APPL_HCI_MODE_LEGACY == appl_scan_mode)
    {
        return GA_FAILURE;
    }

    appl_scan_mode = APPL_HCI_MODE_EXTENDED;
...
void appl_ga_utils_ucc_ascs_parse_and_display_ase_data(UCHAR * data, UINT16 datalen)
{
    ...
    if ((GA_ASE_STATE_IDLE == data[1U]) || (GA_ASE_STATE_RELEASING == data[1U]))
    {
        APPL_TRC("NULL\n");
    }
    else if (GA_ASE_STATE_CODEC_CONF == data[1U])
    {
        APPL_TRC("\n");
    ...
    else if (GA_ASE_STATE_QOS_CONF == data[1U])
    {
        APPL_TRC("\n");
    ...
    else if ((GA_ASE_STATE_ENABLING == data[1U]) ||
             (GA_ASE_STATE_STREAMING == data[1U]) ||
             (GA_ASE_STATE_DISABLING == data[1U]))
    {
        APPL_TRC("\n");
...
void appl_ga_utils_display_adtype_flags(UINT8 flags)
{
    if (BT_AD_FLAGS_LE_LIMITED_DISC_MODE ==
            (BT_AD_FLAGS_LE_LIMITED_DISC_MODE & flags))
    {
        APPL_TRC("LE Limited Discoverable Mode (0x%02X) - ", BT_AD_FLAGS_LE_LIMITED_DISC_MODE);
    }
    if (BT_AD_FLAGS_LE_GENERAL_DISC_MODE ==
            (BT_AD_FLAGS_LE_GENERAL_DISC_MODE & flags))
    {
        APPL_TRC("LE General Discoverable Mode (0x%02X) - ", BT_AD_FLAGS_LE_GENERAL_DISC_MODE);
    }
    if (BT_AD_FLAGS_BR_EDR_NOT_SUPPORTED ==
            (BT_AD_FLAGS_BR_EDR_NOT_SUPPORTED & flags))
    {
        APPL_TRC("BR/EDR Not Supported (0x%02X) - ", BT_AD_FLAGS_BR_EDR_NOT_SUPPORTED);
    }
    if (BT_AD_FLAGS_LE_BR_EDR_CONTROLLER ==
            (BT_AD_FLAGS_LE_BR_EDR_CONTROLLER & flags))
    {
        APPL_TRC("Simultaneous LE and BR/EDR to Same Device Capable (Controller) (0x%02X) - ", BT_AD_FLAGS_LE_BR_EDR_CONTROLLER);
    }
    if (BT_AD_FLAGS_LE_BR_EDR_HOST == (BT_AD_FLAGS_LE_BR_EDR_HOST & flags))
    {
...
void appl_ga_utils_display_announcement_type(UINT8 announcement_type)
{
    ...
    /*
     * The values of CAP and BAP announcements are same, Using one of these
     * Macros.
     */
     ...
     )
{
    if (GA_ROLE_SINK == role)
    {
        local_pacs.record.sink_audio_locations = locations;
    }
    else if (GA_ROLE_SOURCE == role)
    {
        local_pacs.record.src_audio_locations = locations;
    }
    else
    {
        /* No update */
     ...
     )
{
    if (GA_ROLE_SINK == role)
    {
        local_pacs.record.supp_sink_contexts = supp_audio_cntx;
    }
    else if (GA_ROLE_SOURCE == role)
    {
        local_pacs.record.supp_src_contexts = supp_audio_cntx;
    }
    else
    {
        /* No update */
     ...
     )
{
    if (GA_ROLE_SINK == role)
    {
        local_pacs.record.avail_sink_contexts = avail_audio_cntx;
    }
    else if (GA_ROLE_SOURCE == role)
    {
        local_pacs.record.avail_src_contexts = avail_audio_cntx;
    }
    else
    {
        /* No update */
...
void appl_ga_utils_set_default_values_le_conn_params(void)
{
    ...
    if (BD_ADDR_TYPE_RANDOM == device.bd_type)
    {
        le_conn_params.own_addr_type = BD_ADDR_TYPE_RANDOM;
    }
    else
    {
        le_conn_params.own_addr_type = BD_ADDR_TYPE_PUBLIC;
    }

    le_conn_params.scan_interval = 0x0020U;
    le_conn_params.scan_window = 0x0020U;
    le_conn_params.init_filr_policy = 0x00U;
    le_conn_params.peer_addr_type = BD_ADDR_TYPE_PUBLIC;
    GA_mem_set
    (
        &le_conn_params.peer_addr[0U],
        0U,
        sizeof(GA_BD_ADDR_SIZE)
    );

    le_conn_params.conn_interval_min = 0x0050U;
    le_conn_params.conn_interval_max = 0x0050U;
    le_conn_params.conn_latency = 0x00U;
    le_conn_params.supervision_timeout = 0x09D0U;
    le_conn_params.max_ce_len = 0x00U;
    le_conn_params.min_ce_len = 0x00U;
}
...
void appl_ga_utils_set_default_values_le_ext_conn_params(void)
{
    ...
    if (BD_ADDR_TYPE_RANDOM == device.bd_type)
    {
        le_ext_conn_params.own_addr_type = BD_ADDR_TYPE_RANDOM;
    }
    else
    {
        le_ext_conn_params.own_addr_type = BD_ADDR_TYPE_PUBLIC;
    }

    le_ext_conn_params.init_filr_policy = 0x00U;
    le_ext_conn_params.peer_addr_type = BD_ADDR_TYPE_PUBLIC;
    GA_mem_set
    (
        &le_ext_conn_params.peer_addr[0U],
        0U,
        sizeof(GA_BD_ADDR_SIZE)
    );
    le_ext_conn_params.init_phy = 0x01U;
    le_ext_conn_params.scan_interval[0U] = 0x0020U;
    le_ext_conn_params.scan_window[0U] = 0x0020U;
    le_ext_conn_params.conn_interval_min[0U] = 0x0050U;
    le_ext_conn_params.conn_interval_max[0U] = 0x0050U;
    le_ext_conn_params.conn_latency[0U] = 0x00U;
    le_ext_conn_params.supervision_timeout[0U] = 0x09D0U;
    le_ext_conn_params.min_ce_len[0U] = 0x00U;
    le_ext_conn_params.max_ce_len[0U] = 0x00U;
}
...
void appl_ga_utils_verify_rsi(UINT8 cas_index)
{
    ...
    /* Input Connected Device Index */
    dev_index = appl_ga_utils_bap_get_input_conn_dev_index();

    APPL_TRC("GA_cs_rsi_verify...");

    if (CSIP_SIRK_TYPE_ENCRYPTED == conn_dev[dev_index].sm.sirk[0U])
    {
        retval = GA_cs_rsi_verify
                 (
                     &cas_devices[cas_index].rsi[0],
                     &conn_dev[dev_index].decsirk[0U]
                 );
    }
    else
    {
    ...
    {
        /* Update RSI State */
        cas_devices[cas_index].rsi_state = RSI_STATE_VERIFY_ONGOING;

        /* Save the Connected Device Index */
        cas_devices[cas_index].conn_dev_index = dev_index;
    }
}
      ...
      )
{
    ...
    if (75 == fd_as_per_lc3_format)
    {
        n_f_len = ((n_f_len *3) >> 2);
    }
#endif /* LC3_ENABLE_7_5MS_MODE */
    lc3_encoded_bytes = bitrate_in_bps * (INT32)n_f_len / (8 * sf_in_Hz);
