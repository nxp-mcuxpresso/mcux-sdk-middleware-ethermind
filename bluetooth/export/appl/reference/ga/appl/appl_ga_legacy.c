...
void appl_ga_register_ascs(void)
{
    ...
    ase_id = 0U;
    retval = GA_FAILURE;
    GA_mem_set(&local_ase_codec_conf, 0U, sizeof(GA_SEP_CONF));
    GA_mem_set(&local_pref_qos_cap, 0U, sizeof(GA_QOS_CAP));
    GA_mem_set(&cs_conf, 0U, sizeof(GA_LC3_CODEC_SPECIFIC_CONF));
    /*
