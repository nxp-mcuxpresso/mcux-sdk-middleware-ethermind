...
/**
 * This flag controls automatic initiation of HCI LE connection on receiving
 * the Advertising reports from a desired Remote Device.
 */
/* #define APPL_CONFIG_AUTO_CONNECTION_ON_ADV_RECV */
...
static void set_le_tx_power(UCHAR *event_data, UCHAR event_datalen);
#endif /* NXP_CODE */
