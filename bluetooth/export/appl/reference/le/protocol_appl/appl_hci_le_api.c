        ...
        if (API_SUCCESS == retval)
        {
            ...
            if (API_SUCCESS == retval)
            {
                ...
                if (API_SUCCESS == retval)
                {
                    ...
                    conn_interval_min       = (UINT16) 0x0050U;//todo:leaudio
                    conn_interval_max       = (UINT16) 0x0050U;//todo:leaudio
                    conn_latency            = (UINT16) 0x0000U;
...
void appl_hci_le_iso_write(void)
{
    ...
    UINT32     ts;
    UINT16     seq_num;
    UCHAR sdu[50] = { 1,2,3,4,5,6,7,8,9,0x0A,1,2,3,4,5,6,7,8,9,0x0A,1,2,3,4,5,6,7,8,9,0x0A,1,2,3,4,5,6,7,8,9,0x0A,1,2,3,4,5,6,7,8,9,0x0A};
    UINT16     sdu_len;
