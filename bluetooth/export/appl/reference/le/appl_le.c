...
void appl_gatt_db_module_init(void)
{
    ...
    /* Update the number of attributes if for GA */
    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES_16_BIT = 600U;
    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES_128_BIT = 12U;
    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES =
        appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES_16_BIT +
        appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES_128_BIT;

    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_16_BIT_SERVICE_COUNT = 25U;

    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_SERVICE_COUNT =
        (appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_16_BIT_SERVICE_COUNT + appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_128_BIT_SERVICE_COUNT);
#endif /* BT_HAVE_GATT_DB_RECORDS_SORTED_BY_UUID_SIZE */
    appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_TYPE_COUNT = appl_bt_gatt_db_config.config_GATT_DB_DYN_MAX_ATTRIBUTES;
    appl_bt_gatt_db_config.config_GATT_DB_DYN_CHARACTERISTIC_COUNT = 512U; /* 128U */
    appl_bt_gatt_db_config.config_GATT_DB_DYN_VALUE_ARRAY_SIZE = 1024;
#endif /* BT_GAM */
...
{
    ATT_HANDLE_RANGE serv_range;
    API_RESULT retval;

    /* Get the GATT Service Handle Range of the service */
    retval = BT_gatt_db_get_service_range
             (
    ...
    if (API_SUCCESS == retval)
    {
        ...
        retval = appl_update_gatt_service_range_in_sdp_record
                 (
                    sdp_instance,
                    serv_range.start_handle,
                    serv_range.end_handle
                 );
    }
    else
    {
