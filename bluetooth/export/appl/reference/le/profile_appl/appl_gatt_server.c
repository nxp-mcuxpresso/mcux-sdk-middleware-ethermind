           ...
           )
{
    ...
    do
    {
        ...
        /**
         * Use BT_gatt_db_get_handle_value_pair(...) here as this Interface
         * could be used dedicatedly for \ref ATT_READ_BY_TYPE_REQ procedures.
         * In-case BT_gatt_db_fetch_handle_value_pair(...) is to be used,
         * then the "flags" field should contain \ref GATT_DB_READ_BY_TYPE.
         */
    ...
    else
    {
        ...
        case ATT_SIGNED_WRITE_CMD:
...
#ifdef SMP_DATA_SIGNING
            {
                ...
                appl_smp_verify_sign_data (handle->device_id, s_data, s_datalen);
            }
