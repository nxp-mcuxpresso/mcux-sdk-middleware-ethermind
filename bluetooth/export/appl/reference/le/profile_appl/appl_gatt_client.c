...
static const UCHAR *profile_client_menu = (UCHAR *) \
 "\n--------------------------------------------\n"\
   ...
   "--------------------------------------------\n\
    0 - Exit\n\
    1 - Refresh\n\n\
   10 - Device Info Client Operations\n\
   20 - Battery Client Operations\n\
   30 - Health Thermometer Client Operations\n\
   40 - Heart Rate Client Operations\n\
   50 - Running Speed and Cadence Client Operations\n\
   60 - Cycling Speed and Cadence Client Operations\n\
   70 - Location and Navigation Client Operations\n\
   80 - Cycling Power Client Operations\n\
   90 - Weight Scale Client Operations\n\
  100 - Environmental Client Operations\n\
  110 - Bond Management Client Operations\n\
  120 - Automation IO Client Operations\n\
  130 - Indoor Positioning Client Operations\n\
  140 - Proximity Monitor Operations\n\
  150 - Find Me Locator Operations\n\
  160 - HID Host Operations\n\
  170 - Blood Pressure Client Operations\n\
  180 - Phone Alert Client Operations\n\
  190 - Pulse Oximeter Client Operations\n\
  200 - Scan Parameter Client Operations\n\
  210 - Glucose Meter Client Operations\n\
  220 - Time Client Operations\n\
  230 - Continuous Glucose Monitor Client Operations\n\
  240 - Alert Notification Client Operations\n\
  250 - Fitness Machine Client Operations\n\
  260 - Reconnection Configuration Client Operations\n\
  270 - Object Transfer Client Operations\n\
  280 - Insulin Delivery Client Operations\n\
  290 - Internet Protocol Support Router Operations\n\
  300 - HTTP Proxy Client Operations\n\
  310 - Body Composition Client Operations\n\
  320 - User Data Client Operations\n\
  330 - Physical Activity Client Operations\n\
  340 - Binary Sensor Client Operations\n\
  350 - Transport Discovery Client Operations\n\
  360 - Device Time Client Operations\n\
  370 - Emergency Configuration Client Operations\n\
Your Option ?\n";
...
const APPL_UUID_DESC appl_uuid_desc_table[] =
{
    ...
    },
    {
        ...
        (UCHAR *)" POX Continuous Measurement"
    },
    {
    ...
    {
        GATT_GTBS_SERVICE,
        (UCHAR *)"Generic Telephone Bearer Service"
    },
    {
        GATT_HAS_SERVICE,
        (UCHAR *)"Hearing Access Service"
    },
    {
        GATT_TMAS_SERVICE,
        (UCHAR *)"Telephony and Media Service"
    },
    {
        GATT_TMAS_ROLE_CHARACTERISTIC,
        (UCHAR *)"Role characteristic"
    },
    {
        GATT_HAS_HA_FEATURES_CHARACTERISTIC,
        (UCHAR *)"Hearing Aid Features characteristic"
    },
    {
        GATT_HAS_HA_PRESET_CP_CHARACTERISTIC,
        (UCHAR *)"Hearing Aid Preset Control Point characteristic"
    },
    {
        GATT_HAS_ACTIVE_PRESET_INDEX_CHARACTERISTIC,
        (UCHAR *)"Active Preset Index characteristic"
    },
    {
    ...
    {
        GATT_MCS_PARENT_GRP_OBJ_ID_CHARACTERISTIC,
        (UCHAR *)"Parent Group Object Characteristic"
    },
    {
           ...
           )
{
    ...
    case ATT_HANDLE_VALUE_MULTIPLE_NTF:
        ...
        case ATT_READ_MULTIPLE_VARIABLE_LENGTH_RSP:
            CONSOLE_OUT("Received read multiple variable length response Opcode - %d\n", event_datalen);
            ...
            if (NULL != event_data)
            {
                 ...
                 * (<Handle:2 Octet><Length:2 Octet><Value:Length no of Octets>) tuples
                 */
                CONSOLE_OUT("Byte stream of values received [not seperated by handles]");
                appl_dump_bytes(event_data, event_datalen);
                CONSOLE_OUT("\n");
            }
            break;
        ...
        case GATT_CHAR_UUID_DISCOVERY_RSP:
            CONSOLE_OUT("Received GATT_CHAR_UUID_DISCOVERY_RSP\n");
        ...
        case 95:
#ifdef ATT_ON_ECBFC_SUPPORT
            {
                ...
                else
                {
                    ...
                    appl_l2cap_ecbfc_connect_param.credit = 0x01U;
