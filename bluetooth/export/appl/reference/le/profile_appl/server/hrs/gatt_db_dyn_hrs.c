...
/* Service Instances */
UINT16 GATT_SER_HRS_GAP_INST;
UINT16 GATT_SER_HRS_GATT_INST;
UINT16 GATT_SER_HRS_BATTERY_INST;
UINT16 GATT_SER_HRS_DEV_INFO_INST;
UINT16 GATT_SER_HRS_HEART_RATE_INST;

/* Characteristic Instances */
UINT16 GATT_CHAR_HRS_BATTERY_LVL_INST;
UINT16 GATT_CHAR_HRS_HR_MSRMNT;
UINT16 GATT_CHAR_HRS_BODY_SNSR_LOC_INST;
UINT16 GATT_CHAR_HRS_HR_CNTRL_PNT_INST;
...
API_RESULT appl_hrs_add_gaps(void)
{
    ...
    {
        APPL_TRC(
        "[HRS APPL]: BT_gatt_db_add_service() failed. Result: 0x%04X\n",
        retval);
    }
    else
    {
        /* Store the Service Handle in the Global */
        GATT_SER_HRS_GAP_INST = service_handle;
        ...
        char_value.val         = (UCHAR *)"Mindtree-HRS";
        ...
        {
            APPL_TRC(
            "[HRS APPL]: BT_gatt_db_add_characteristic() failed. Result: 0x%04X\n",
            retval);
        }
...
API_RESULT appl_hrs_add_gatts(void)
{
    ...
    else
    {
        ...
        GATT_SER_HRS_GATT_INST  = service_handle;
...
API_RESULT appl_hrs_add_bas(void)
{
    ...
    else
    {
        ...
        GATT_SER_HRS_BATTERY_INST  = service_handle;
        ...
        else
        {
            ...
            GATT_CHAR_HRS_BATTERY_LVL_INST = char_handle;
...
API_RESULT appl_hrs_add_dis(void)
{
    ...
    else
    {
        ...
        GATT_SER_HRS_DEV_INFO_INST  = service_handle;
        ...
        /* Model Number */
        /* HRS-1.0.0 */
        UCHAR model_number[]   = { 'H', 'R', 'S', '-', '1', '.', '0', '.', '0' };
        char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
...
API_RESULT appl_hrs_add_hrs(void)
{
    ...
    service_info.is_primary        = BT_TRUE;
    service_info.uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
    service_info.uuid.uuid.uuid_16 = GATT_HEART_RATE_SERVICE;
    ...
    {
        GATT_SER_HRS_HEART_RATE_INST = service_handle;

        /* Heart Rate Measurment */
        /* Mindtree Limited */
        char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
        char_uuid.uuid.uuid_16 = GATT_HR_MSRMT_CHARACTERISTIC;
        perm                   = GATT_DB_PERM_NONE;
        ...
        {
            /* Save HRS Measurement Characteristic Instance for future reference */
            GATT_CHAR_HRS_HR_MSRMNT = char_handle;
        }
        ...
        char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
        char_uuid.uuid.uuid_16 = GATT_BODY_SENSOR_LOC_CHARACTERISTIC;
        perm                   = GATT_DB_PERM_READ;
        property               = GATT_DB_CHAR_READ_PROPERTY;
        sensor_loc             = APPL_HRS_BODY_SENSOR_LOCATION;
        ...
        {
            /* Save HRS Body Sensor Instance for future reference */
            GATT_CHAR_HRS_BODY_SNSR_LOC_INST = char_handle;
        }

        /* Heart Rate Control point */
        char_uuid.uuid_format  = ATT_16_BIT_UUID_FORMAT;
        char_uuid.uuid.uuid_16 = GATT_HR_CNTRL_POINT;
        ...
        {
            /* Save HRS Control Point Characteristic Instance for future reference */
            GATT_CHAR_HRS_HR_CNTRL_PNT_INST = char_handle;
        }
    }
