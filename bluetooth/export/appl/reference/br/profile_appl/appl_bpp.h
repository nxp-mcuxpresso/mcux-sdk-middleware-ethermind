...
/**
 * Application Flag to include 'BPP_CHARACTER_REPERTOIRES_SUPPORTED_ATTR_ID'
 * in the SDP query
 * This is requiredf for 'BPP/PR/OF/BV-15-I' NON-PTS Test Case.
 */
/* #define APPL_BPP_SENDER_SDP_EXT */
