...
========= MCAP Menu =============== \n\
 ...
 \n\
    2.  MCAP Registration \n\
 \n\
    3.  Register BD_ADDR of peer MCAP \n\
 ...
 \n\
   ...
   23. Delete all data channels\n\
   24. Reconnect Data Channel\n\
   25. Abort Data Channel\n\
   26. Write Data on Data Channel\n\
\n\
   27. Set Streaming Channel Param for accept\n\
   28. Set Reliable Channel Params for accept\n\
   29. Set No Channel Preference Params for accept\n\
...
void main_mcap_operations (void)
{
    ...
    BT_LOOP_FOREVER()
    {
        ...
        case 3: /* Register BD_ADDR of peer device */
            printf("Please enter BD ADDR of peer MCAP\n");
        ...
        case 5:
            ...
            retval = BT_hci_disconnect ((UINT16)connection_handle, 0x13 );
...
void appl_mcap_mc_connect (void)
{
    ...
    printf ("\nInitiating MCAP MC Create req with Peer Device: "
