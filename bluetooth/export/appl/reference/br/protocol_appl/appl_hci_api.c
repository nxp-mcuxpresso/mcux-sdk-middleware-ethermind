...
/* Device global CoD */
DECL_STATIC UINT32 appl_hci_classofdevice;
...
void appl_hci_write_classofdevice(UINT32 cod)
{
#ifdef BR_EDR_HCI
    UINT32 class_of_device;
    API_RESULT retval;

    /* Update to Global CoD */
    class_of_device = appl_hci_classofdevice | cod;
    ...
    else
    {
        ...
        /* Update the global CoD */
        appl_hci_classofdevice = class_of_device;
    }
#endif /* BR_EDR_HCI */
}
...
API_RESULT appl_hci_write_class_of_device ( void )
{
    ...
    if (API_SUCCESS == retval)
    {
        ...
        class_of_device = appl_hci_classofdevice | (UINT32)read_val;
