...
/**
 * ERTM Only Mode configuration for a few L2CAP PTS Test Cases
 *
 * 1 : ERTM Only Mode (using while responding to connection request)
 * 0 : Not ERTM Only Mode
 */
//DECL_STATIC UCHAR appl_l2cap_ertm_only_mode = 0U;
...
void main_l2cap_operations (void)
{
    ...
    BT_LOOP_FOREVER()
    {
        ...
        case 52:
            //appl_l2cap_ertm_only_mode = 0x01U;
            break;

        case 53:
            //appl_l2cap_ertm_only_mode = 0x00U;
            break;
