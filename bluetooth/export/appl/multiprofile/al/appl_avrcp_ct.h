...
#define AVRCP_ATTR_STR_LEN 255U
#define AVRCP_ATTR_NUM_LEN 10U

typedef struct
{
	UCHAR title[AVRCP_ATTR_STR_LEN];
	UCHAR artist[AVRCP_ATTR_STR_LEN];
	UCHAR album[AVRCP_ATTR_STR_LEN];
	UCHAR track_num[AVRCP_ATTR_NUM_LEN];
	UCHAR total_tracks[AVRCP_ATTR_NUM_LEN];
	UCHAR genre[AVRCP_ATTR_STR_LEN];
	UCHAR play_time[AVRCP_ATTR_STR_LEN];
} AVRCP_ELEMENT_ATTR;
