...
void appl_hci_inquiry ( void )
{
    ...
    /* 0x9E8B33U is the LAP for General Inquiry */
    lap = 0x9E8B33U;
    /*
     ...
     */
    inq_resp = INQUIRY_NUM_RESPONSES;
...
void appl_hci_enhanced_setup_synchronous_connection ( void )
{
    ...
    esco_params.input_pcm_smpl_payload_msb_pos  = 0x00U; /* dummy */
    esco_params.output_pcm_smpl_payload_msb_pos = 0x00U; /* dummy */
