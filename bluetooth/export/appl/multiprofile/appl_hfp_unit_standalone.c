...
/**
 *  \file appl_hfp_unit_standalone.c
 *
...
#define HFP_UNIT_OK_STR         (CHAR *)"\r\nOK\r\n"
#define HFP_UNIT_ERROR_STR      (CHAR *)"\r\nERROR\r\n"
#define HFP_UNIT_CLIP_STR       (CHAR *)"\r\nRING\r\n"
#define HFP_UNIT_CALLACTIVE_STR (CHAR *)"\r\nACTIVE\r\n"
...
void main_hfp_unit_standalone_operations (void)
{
    ...
    BT_LOOP_FOREVER()
    {
        ...
        case 4: /* Initialise Hands-Free Unit */
            api_retval = BT_hfp_unit_init(appl_callback_registered_with_standalone_hfu);

            CONSOLE_OUT("> API RETVAL BT_hfp_unit_init : 0x%04X\n",api_retval);
            ...
            {
                CONSOLE_OUT("> HFP_UNIT Init Successful\n");
        ...
        case 5: /* Start Hands-Free Unit */
            ...
            CONSOLE_OUT ("\t---\t-------\n");
            CONSOLE_OUT ("\t 0  \tEC and/or NR function\n");
            CONSOLE_OUT ("\t 1  \tCall waiting or 3-way calling\n");
            CONSOLE_OUT ("\t 2  \tCLI presentation capability\n");
            CONSOLE_OUT ("\t 3  \tVoice recognition activation\n");
            CONSOLE_OUT ("\t 4  \tRemote volume control\n");
            CONSOLE_OUT ("\t 5  \tEnhanced call status\n");
            CONSOLE_OUT ("\t 6  \tEnhanced call control\n");
            CONSOLE_OUT ("\t 7  \tCodec negotiation\n");

#ifdef HFP_UNIT_1_7
            CONSOLE_OUT ("\t 8  \tHF Indicators\n");
            CONSOLE_OUT ("\t 9  \teSCO S4(T2) Settings Support\n");
#endif /* HFP_UNIT_1_7 */

#ifdef HFP_UNIT_1_8
            CONSOLE_OUT ("\t 10 \tEnhanced Voice Recognition Status\n");
            CONSOLE_OUT ("\t 11 \tVoice Recognition Text\n");
#endif /* HFP_UNIT_1_8 */

            CONSOLE_OUT("Enter Local HFP_UNIT Supported Features(as Decimal value)\n:");
            CONSOLE_IN("%s", hfp_unit_local_supported_features);
            ...
            for (i= 0; i< str_len; i++)
            {
                ...
                {
                    CONSOLE_OUT("Invalid Supported Features\n");
            ...
            if (API_SUCCESS == api_retval)
            {
...
#ifdef HFP_UNIT_1_6
                CONSOLE_OUT("Enter Local HFP_UNIT list of available Codecs\n");
                CONSOLE_OUT("\t1   -> for CVSD\n");
                CONSOLE_OUT("\t1,2 -> for CVSD, mSBC\n:");
                CONSOLE_IN("%s", hfp_unit_local_available_codecs);

                int var1 = BT_str_n_len(hfp_unit_local_available_codecs, sizeof(hfp_unit_local_available_codecs));
                if (var1 > 3)
                {
                    CONSOLE_OUT("invalid Codecs parameters entered \n");
                    break;
                }
                ...
                {
                    CONSOLE_OUT("CVSD Codec selection is mandatory\n");
                    break;
                }
                else
                {
                    CONSOLE_OUT("invalid Codecs Selected\n");
                    break;
                }

#ifdef HFP_UNIT_1_7
                CONSOLE_OUT("Enter Local HFP_UNIT list of available HF Indicators \n");
                CONSOLE_OUT("\t1    -> for Enhanced Safety \n");
                CONSOLE_OUT("\t2    -> for Battery Level \n");
                CONSOLE_OUT("\t1,2  -> for both Enhanced Safety and Battery Level\n");
                CONSOLE_IN("%s", hfp_unit_local_supported_hf_indicators);

                int var2 = BT_str_n_len(hfp_unit_local_supported_hf_indicators, sizeof(hfp_unit_local_supported_hf_indicators));
                if (var2 > 3)
                {
                    CONSOLE_OUT("invalid indicator \n");
                    break;
                }
                ...
                {
                    CONSOLE_OUT("invalid indicator Selected\n");
                    break;
                }
                ...
                (BT_IGNORE_RETURN_VALUE)appl_start_hfu_standalone
                (
                    &appl_hfp_unit_conf_params
                );
#else /* HFP_UNIT_1_6 */
                appl_start_hfu_standalone
                (
                    hfp_unit_local_supported_features,
        ...
        case 6: /* Stop Hands-Free Unit */
            ...
            {
                CONSOLE_OUT("> STOP_PENDING.........\n");
                CONSOLE_OUT("> Wait for Confirmation..\n");
            }
            else
            {
                CONSOLE_OUT("> API RETVAL Profile Stop 0x%04X\n", api_retval);
        ...
        case 8: /* Get AG's SDP record */
            /* Set the SDP Handle */
            SDP_SET_HANDLE(hfp_sdp_handle,appl_peer_bd_addr,appl_hfu_standalone_sdp_cb);
        ...
        case 9: /* Establish SLC connection with AG */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_connect: 0x%04X\n",
            api_retval);
            break;
        ...
        case 10: /* Release SLC with AG */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_disconnect 0x%04X\n",
            api_retval);
        ...
        case 11:/* Release ACL with AG */
            ...
            {
                CONSOLE_OUT ("ACL Connection for HSP-Unit not found\n");
        ...
        case 19:
            ...
            appl_hfpunit_standalone_create_eSCO_connection();
            break;
        ...
        case 21:
            ...
            {
                CONSOLE_OUT("API RETVAL Establish Synchronous Connection"\
        ...
        case 44: /* Transfer Call to AG */
            ...
            CONSOLE_OUT("> API RETVAL Transfer Call to AG : 0x%04X\n", api_retval);
            break;
        ...
        case 25:
            CONSOLE_OUT("Select CVSD eSCO parameter set (1-S1, 2-S2, 3-S3, 4-S4): ");
            CONSOLE_IN("%d", &choice);
        ...
        case 26:
            CONSOLE_OUT("Select mSBC eSCO parameter set (1-T1, 2-T2): ");
            CONSOLE_IN("%d", &choice);
        ...
        case 27:
            appl_hfpunit_standalone_change_esco_config();
            break;

        case 30:/* Dial with number */
            CONSOLE_OUT("Enter the number to dial : ");
            CONSOLE_IN("%s",dialeddigits);
            ...
            for (i = 0U; i < BT_str_len(dialeddigits); i++)
            {
                ...
                {
                    CONSOLE_OUT ("Invalid Dial Number Entered\n");
                    break;
                }
                else
                {
                    api_retval = BT_hfp_unit_dial
                     ...
                     CONSOLE_OUT("> API RETVAL BT_hfp_unit_dial: 0x%04X\n", api_retval);
                }
            }
            break;

        case 31: /* Memory Dialing */
            CONSOLE_OUT("Input the Memory Location : ");
            CONSOLE_IN("%s", (char *)memid);
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_memdial 0x%04X\n",
            api_retval);
            break;
        ...
        case 32: /* Last Number ReDial */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_redial : 0x%04X\n",
            api_retval);
            break;
        ...
        case 40: /* Accept Incoming Call */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_callaccept : 0x%04X\n",
            api_retval);
            break;
        ...
        case 42: /* Hang Up ongoing call */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_callhangup : 0x%04X\n",
            api_retval);
            break;
        ...
        case 45:/* Three Way Call (TWC) Options */
             ...
             */
            CONSOLE_OUT(" 0. Release all Held Calls and set UUDB tone " \
                   "(Reject new incoming waiting call)\n");
            CONSOLE_OUT(" 1. Release Active Calls and accept held/waiting call\n");
            CONSOLE_OUT(" 2. Hold Active Call and accept already " \
                   "held/new waiting call\n");
            CONSOLE_OUT(" 3. Conference all calls\n");
            CONSOLE_OUT(" 4. Connect other calls and disconnect self from TWC\n");

            CONSOLE_OUT("Your choice : ");
            CONSOLE_IN("%u", &choice);
            option = (UCHAR)choice;
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_control_multi_party_call"\
            "0x%04X\n", api_retval);
            break;
        ...
        case 50: /* Enable CLIP Notification */
            ...
            CONSOLE_OUT("> API RETVAL Enable CLIP 0x%04X\n",api_retval);
            break;
        ...
        case 51: /* Disable CLIP Notification */
            ...
            CONSOLE_OUT("> API RETVAL Disable CLIP 0x%04X\n",api_retval);
            break;
        ...
        case 52: /* Enable Call Waiting Notification */
            ...
            CONSOLE_OUT("> API RETVAL Enable CCWA 0x%04X\n",api_retval);
            break;
        ...
        case 53: /* Disable Call Waiting Notification */
            ...
            CONSOLE_OUT("> API RETVAL Disable CCWA 0x%04X\n",api_retval);
            break;
        ...
        case 54: /* Enable Voice Recognition */
            ...
            CONSOLE_OUT("> API RETVAL Enable BVRA 0x%04X\n",api_retval);
            break;
        ...
        case 55: /* Disable Voice Recognition */
            ...
            CONSOLE_OUT("> API RETVAL Disable BVRA 0x%04X\n",api_retval);
            break;
        ...
        case 56: /* Disable ECNR in AG */
            ...
            CONSOLE_OUT("> API RETVAL Disable ECNR 0x%04X\n",api_retval);
            break;
        ...
        case 57: /* Get Voice-tag Phone Number */
            ...
            CONSOLE_OUT("> API RETVAL Get BINP 0x%04X\n",api_retval);
            break;

        case 60: /* Set Speaker Volume */
            CONSOLE_OUT("Enter Speaker Volume\n");
            CONSOLE_OUT("NOTE: Speaker Volume min value is 0, max value is 15\n");
            fflush(stdin);
            CONSOLE_IN("%s", (char *)gain);
            ...
            if (15U < input_gain)
            {
                CONSOLE_OUT("> Invalid value of Speaker Volume \n");
                break;
            }
            ...
            CONSOLE_OUT("> API RETVAL Set Volume 0x%04X\n",api_retval);
        ...
        case 61: /* Set Microphone Gain */
            CONSOLE_OUT("NOTE: Microphone Gain min value is 0, max value is 15\n");
            CONSOLE_OUT("Enter Microphone Gain\n");
            fflush(stdin);
            CONSOLE_IN("%s", (char *)gain);
            ...
            if (15U < input_gain)
            {
                CONSOLE_OUT("> Invalid value of Microphone Gain \n");
                break;
            }
            ...
            CONSOLE_OUT("> API RETVAL Set Gain 0x%04X\n",api_retval);
        ...
        case 62:/* Get Speaker Volume & Microphone Gain */
            CONSOLE_OUT("> Speaker Volume  : %s\n",
            appl_speaker_volume[g_hfp_unit_handle]);

            CONSOLE_OUT("> Microphone Gain : %s\n",
            appl_microphone_gain[g_hfp_unit_handle]);
        ...
        case 70: /* Get peer Indicator status */
            ...
            CONSOLE_OUT("> API RETVAL get_peer_indicator_status: 0x%04X\n",
            api_retval);
            break;
        ...
        case 71:/* Get peer Indicator List */
            ...
            CONSOLE_OUT("> API RETVAL get_peer_indicator_list: 0x%04X\n",
            api_retval);
            CONSOLE_OUT("> Indicator List:\n");
            CONSOLE_OUT("    Service Max Value : %d\n"  \
                   "    Service Min Value : %d\n"  \
                   "    Call Max Value : %d\n"     \
                   "    Call Min Value : %d\n"     \
        ...
        case 72: /* Get peer supported CHLD values */
            ...
            if (API_SUCCESS == api_retval)
            {
                ...
                {
                    CONSOLE_OUT("> CHLD Not Supported by AG\n");
                }
                else
                {
                    CONSOLE_OUT("> chld_value %s\n",
                    ag_chld_values.peer_hold_value);
                    CONSOLE_OUT("> hold count %d\n",
         ...
         case 73: /* Send DTMF Code */
             CONSOLE_OUT("Enter the DTMF Code : ");
             CONSOLE_IN("%s", dialeddigits);
             ...
             CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_dtmf: 0x%04X\n",
             api_retval);
             break;

        case 74: /* Use HF 1.5 Features */
        #ifdef HFP_UNIT_1_5
            appl_hfp_unit_standalone_1_5_choice_hdlr();
            CONSOLE_OUT("%s\n", hfp_unit_options);
        #else  /* HFP_UNIT_1_5 */
            CONSOLE_OUT("HFP UNIT 1.5 Feature not enabled\n");
        #endif /* HFP_UNIT_1_5 */
            break;

        case 75: /* Use HF 1.6 Features */
        #ifdef HFP_UNIT_1_6
            appl_hfp_unit_standalone_1_6_choice_hdlr();
            CONSOLE_OUT("%s\n", hfp_unit_options);
        #else  /* HFP_UNIT_1_6 */
            CONSOLE_OUT("HFP UNIT 1.6 Feature not enabled\n");
        #endif /* HFP_UNIT_1_6 */
            break;
        ...
        case 76: /* Send String to AG */
            ...
            CONSOLE_OUT("Enter the string\n");
            CONSOLE_IN("%"FSTR(HFP_UNIT_MAX_COMMAND_LENGTH)"s",send_string);
            CONSOLE_OUT("Enter string length\n");
            ...
            CONSOLE_OUT("> API RETVAL - BT_hfp_unit_send_string 0x%04X\n",
            api_retval);
        ...
        case 77: /* Send custom AT command to AG */
            {
            BT_mem_set(send_string, 0, sizeof(send_string));
            CONSOLE_OUT("Enter the AT command\n");
            CONSOLE_IN("%"FSTR(HFP_UNIT_MAX_COMMAND_LENGTH)"s",send_string);
        ...
        case 80: /* Abort HF Procedure */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_abort 0x%04X \n",api_retval);
            break;

        case 90: /* List all BD_ADDR */
            for (i = 0U;i < HFP_UNIT_MAX_CONNECTIONS ; i++)
            {
                CONSOLE_OUT("> Instance: 0x%02X "
        ...
        case 91U :
            CONSOLE_OUT("> Select HFP Unit Handle\n");
            CONSOLE_IN("%d", &read_val);

            /* Check Validity of HFP Unit Handle */
            if (read_val >= HFP_UNIT_MAX_CONNECTIONS)
            {
                CONSOLE_OUT("Handle %d out of Range (0 - %d)\n",
        ...
        case 92U :
            CONSOLE_OUT("> Current HFP Unit Handle : %d\n",
        ...
        case 93: /* Update HF indicator value */
...
#ifdef HFP_UNIT_1_7
            CONSOLE_OUT (" 1. Send BIEV Command\n");
            CONSOLE_OUT (" 2. Display Peer Supported HF indicators Status\n");
            CONSOLE_OUT (" Select Option: ");
            CONSOLE_IN("%d",&read_val);
            ...
            if (1U == read_val)
            {
                ...
                CONSOLE_OUT ("Select options below:\n");
                CONSOLE_OUT("    0 -> To Disable Enhanced Safety. \n");
                CONSOLE_OUT("    1 -> To Enable Enhanced Safety. \n");
                CONSOLE_OUT("    2 -> Send Battery Level. \n");
                CONSOLE_IN("%d",&biev_option);
                ...
                else if (0x02U == biev_option)
                {
                    ...
                    CONSOLE_OUT ("Enter the battery level <= 100(in decimal format):");
                    CONSOLE_IN ("%s", batter_level);
                ...
                CONSOLE_OUT("BT_hfp_unit_update_hf_ind_value returned 0x%04X\n", api_retval);
            }
            else if (2U == read_val)
            {
                CONSOLE_OUT ("No. of Indicators: 0x%02x\n", hfp_unit_peer_hf_ind_count);
                CONSOLE_OUT ("HF indicators Info.\n");
                for (i = 0U; i < hfp_unit_peer_hf_ind_count; i++)
                {
                    CONSOLE_OUT ("    ID    : 0x%08x\n", hfp_unit_peer_hf_ind_list_info[i].hf_ind_id);
                    CONSOLE_OUT ("    Value : 0x%02x\n", hfp_unit_peer_hf_ind_list_info[i].hf_ind_val);
                }
            }
            else
            {
...
#else
            CONSOLE_OUT ("Please Enable HFP_UNIT_1_7 flag \n");
#endif /* HFP_UNIT_1_7 */
        ...
        case 94:
...
#ifdef HFP_UNIT_1_8
            CONSOLE_OUT (" 1. Send AT+BRVA=2 Command\n");
            CONSOLE_OUT (" Select Option: ");
            CONSOLE_IN ("%d", &read_val);
            ...
            if (1U == read_val)
            {
                ...
                CONSOLE_OUT ("> API RETVAL Enable Enhanced Voice Recognition 0x%04X\n", api_retval);
            }
#else
            CONSOLE_OUT ("Please Enable HFP_UNIT_1_8 flag \n");
#endif /* HFP_UNIT_1_8 */
...
void appl_hfp_unit_standalone_1_5_choice_hdlr( void )
{
    ...
    BT_LOOP_FOREVER()
    {
        ...
        case 2:/* Request AG Subscriber Number */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_request_subscriber_num "\
            "0x%04X\n",retval);
            break;
        ...
        case 3:/* Query Response And Hold Status */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_query_resp_hold_status 0x%04X\n",
            retval);
            break;
        ...
        case 4:/* Set Network Name Format */
            ...
            CONSOLE_OUT("> BT_hfp_unit_set_network_name_format 0x%04X\n",retval);
            break;
        ...
        case 5:/* Query Operator Selection */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_query_operator_selection "\
            "0x%04X\n",retval);
            break;
        ...
        case 6:/* Query List of Current Calls */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_get_list_current_calls"\
            " 0x%04X\n", retval);
            break;

        case 7:/* Send Resposne and Hold to AG */
            CONSOLE_OUT("Enter Response and Hold Option\n");
            CONSOLE_OUT("0. INCALL HOLD\n");
            CONSOLE_OUT("1. INCALL ACCEPT\n");
            CONSOLE_OUT("2. INCALL REJECT\n");
            CONSOLE_IN("%d", &choice);
            option = (UCHAR)choice;
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_resp_hold_values 0x%04X\n",
            retval);
            break;

        case 8:/* Send Call Hold with Call ID */
            CONSOLE_OUT("Enter Call ID\n");
            fflush(stdin);
            CONSOLE_IN("%c", &option1.call_id);
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_adv_call_hold 0x%04X\n",
            retval);
            break;
        ...
        case 9: /* Enable CMEE Error Reporting */
            ...
            CONSOLE_OUT("> API RETVAL CMEE Enable 0x%04X\n",retval);
            break;
        ...
        case 10: /* Disable CMEE Error Reporting */
            ...
            CONSOLE_OUT("> API RETVAL CMEE Disable 0x%04X\n",retval);
            break;
...
void appl_hfp_unit_standalone_1_6_choice_hdlr( void )
{
    ...
    BT_LOOP_FOREVER()
    {
        ...
        case 2:/* (De)Activate individual indicators */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_iia "\
            "0x%04X\n",retval);
            }
            break;
        ...
        case 3:/* (De)Activate individual indicators with activation bitmask */
            ...
            CONSOLE_IN("%u", &iia_bit_mask_length);
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_iia_simple_bitmask "\
            "0x%04X\n",retval);
            }
            break;
        ...
        case 4:/* (De)Activate individual indicators with new and previous activation bitmask */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_iia_new_and_curr_bitmask "\
            "0x%04X\n",retval);
            }
            break;
        ...
        case 5:/* (De)Activate individual indicators with required indicators and activation bitmask */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_iia_actvn_and_req_ind_bitmask "\
            "0x%04X\n",retval);
            }
            break;
        ...
        case 6:/* Inform AG about available codecs */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_avl_cdc_list 0x%04X\n",
            retval);
            }
            break;
        ...
        case 7:/* Inform AG about available codecs (numeric) */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_avl_cdc_list_num 0x%04X\n",
            retval);
            }
            break;
        ...
        case 8:/* Trigger Codec Connection */
            ...
            CONSOLE_OUT("> BT_hfp_unit_trigger_codec_connection 0x%04X\n",retval);
            break;
        ...
        case 9:/* Confirm Codec Selection */
            ...
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_send_codec_confirmation "\
            "0x%04X\n",retval);
            }
            break;
        ...
        case 10:/* Confirm Codec Selection (numeric) */
            ...
            CONSOLE_IN("%x", &codec_id);
            retval = BT_hfp_unit_codec_confirmation_num
                     (
                         g_hfp_unit_handle,
                         (HFP_UNIT_CODEC_ID)codec_id
                     );
            CONSOLE_OUT("> API RETVAL BT_hfp_unit_codec_confirmation_num "\
            "0x%04X\n",retval);
            }
            break;
           ...
           )
{
    ...
    else
    {
        ...
        case HFP_UNIT_BCS_IND:              /* Fall Through */
             ...
             */
            (BT_IGNORE_RETURN_VALUE)appl_hfp_standalone_extract_result
            (
...
#ifdef HFP_BRIDGING_STANDALONE
            if (( appl_hfu_slc == APPL_UNIT_SLC_CONNECTED) && ( appl_hfpag_standalone_is_ag_connected() == BT_TRUE) &&
                    event != HFP_UNIT_BCS_IND )
            {
                ...
                appl_hfag_standalone_read_pl(data_to_app->buffer, data_to_app->buffer_len);
            }
#endif /* HFP_BRIDGING_STANDALONE */
            break;
        ...
        default:
            ...
            if ((appl_hfu_slc == APPL_UNIT_SLC_CONNECTED) && (appl_hfpag_standalone_is_ag_connected() == BT_TRUE))
            {
                ...
                appl_hfp_standalone_handle_bridge_app_cmds(event,data,data_len);
            }
#endif /* HFP_BRIDGING_STANDALONE */
            break;
        ...
        case HFP_UNIT_CONNECT_CNF:
            ...
            CONSOLE_OUT("> Instance       : 0x%02X\n", (unsigned int) handle);
            CONSOLE_OUT("> Event result   : 0x%04X\n",result);
            if (API_SUCCESS == result)
            {
                ...
                CONSOLE_OUT("> BD_ADDR of peer %02X:%02X:%02X:%02X:%02X:%02X\n",
       ...
       case HFP_UNIT_DISCONNECT_IND:
        ...
        case HFP_UNIT_CALLSETUP:
            ...
            if (data != NULL)
            {
                CONSOLE_OUT("> Call Setup Value : %d\n",*(UCHAR *)data);
            }
        ...
        case HFP_UNIT_PEER_IND_STATUS_IND:
            ...
            CONSOLE_OUT("> ID : Battchg %d\n",cind_result->battchg);
            CONSOLE_OUT("> ID : Call %d\n",cind_result->call);
            CONSOLE_OUT("> ID : Call_Setup %d\n",cind_result->call_setup);
            CONSOLE_OUT("> ID : CallHeld %d\n", cind_result->callheld);
            CONSOLE_OUT("> ID : Callsetup %d\n", cind_result->callsetup);
            CONSOLE_OUT("> ID : Roam %d\n", cind_result->roam);
            CONSOLE_OUT("> ID : Service %d\n", cind_result->service);
            CONSOLE_OUT("> ID : Signal %d\n", cind_result->signal);
            break;

        case HFP_UNIT_AG_ERROR_IND:
            CONSOLE_OUT("\n> Event     : HFP_UNIT_AG_ERROR_IND\n");
            CONSOLE_OUT("> Instance  : 0x%02X\n", (unsigned int) handle);
            CONSOLE_OUT("> Error     : 0x%04X\n", result);
            break;

        case HFP_UNIT_CMEE_IND:
            CONSOLE_OUT("\n> Event          : HFP_UNIT_CMEE_IND\n");
            CONSOLE_OUT("> Instance       : 0x%02X\n", (unsigned int) handle);
            CONSOLE_OUT("> CMEE ERR Value : %d\n",
            app_parser_result.result_param.uchar_result);
            break;
        ...
        case HFP_UNIT_RECVD_DATA_IND:
            ...
            if(data != NULL)
            {
                ...
                {
                    CONSOLE_OUT("%c ",data_recvd[index]);
                }
                CONSOLE_OUT("\n------------------------------------------------\n");
                CONSOLE_OUT("\n----------------HEX DUMP------------------------\n");
                for(index = 0U; index <data_len; index++ )
                {
                    CONSOLE_OUT("%X ",data_recvd[index]);
                }
                CONSOLE_OUT("\n------------------------------------------------\n");
            }
            break;
...
#ifndef HFP_BRIDGING_STANDALONE
                appl_hfu_slc = 0U;
#endif /* HFP_BRIDGING_STANDALONE */
            }
            break;
        ...
        case HFP_UNIT_BCS_IND:
        {
            ...
            {
                CONSOLE_OUT ("Codec Selection: CVSD\n");
            ...
            {
                CONSOLE_OUT ("Codec Selection: mSBC\n");
#ifdef HCI_ENH_SCO
        ...
        case HFP_UNIT_BIND_IND:
            ...
            CONSOLE_OUT ("Updated HF Indicator Info:\n");
            ...
            CONSOLE_OUT ("Sending AT+BIEV Command to Synchronize HF Unit & AG\n");
            ...
            if (API_SUCCESS != retval)
            {
                CONSOLE_OUT("Failed: BT_hfp_unit_update_hf_ind_value 0x%04X\n", retval);
            }
             ...
             (API_SUCCESS == result))
        {
            ...
            if (API_SUCCESS == retval)
            {
                CONSOLE_OUT ("=== Peer HF indicators info. ===\n");
                CONSOLE_OUT ("No. of Indicators: 0x%02x\n", hfp_unit_peer_hf_ind_count);
                CONSOLE_OUT ("HF indicators status:\n");
                for (index = 0U; index < hfp_unit_peer_hf_ind_count; index++)
                {
     ...
     )
{
    ...
    if (API_SUCCESS == retval)
    {
        ...
        default: /* Invalid: Nothing to do */
            CONSOLE_OUT("Invalid Command Type: 0x%02X\n", command);
            break;
           ...
           )
{
    ...
    default:
        CONSOLE_OUT("Invalid keyword type: %d\n", parser_response->keyword_type);
        break;
    } /* switch (keyword type) */
...
{
    BT_mem_copy(buffer,str,BT_str_len(str));
    if(data!= NULL)
    {
      BT_str_print((buffer + BT_str_len(str) ),"%d",*(UCHAR*)data);
      *(buffer + BT_str_len(str) + data_len) = '\0';
    }
    else
    {
       *(buffer + BT_str_len(str) ) = '\0';   
    }
...
void appl_hfp_standalone_handle_bridge_app_cmds(HFP_UNIT_EVENTS event, void *data, UINT16 data_len)
{
    ...
    {
            case HFP_UNIT_AG_ERROR_IND:
                appl_hfag_standalone_read_pl(HFP_UNIT_ERROR_STR, (UCHAR)BT_str_len(HFP_UNIT_ERROR_STR));
                break;
            ...
            case HFP_UNIT_OK_IND:
                 ...
                 appl_hfag_standalone_read_pl(HFP_UNIT_OK_STR, (UCHAR)BT_str_len(HFP_UNIT_OK_STR));
                 break;

            case HFP_UNIT_OUTCALL_CNF:
            case HFP_UNIT_CALLHANGUP_CNF:
                 appl_hfag_standalone_read_pl((char*)"OK", (UCHAR)BT_str_len((char*)"OK"));
                 break;
        ...
        case HFP_UNIT_CALLSETUP:
                 ...
                 cmd_str="\r\n+CIEV:3,";
                 appl_hfp_standalone_add_cmd_string(cmd_str, buffer, data, data_len);
                 CONSOLE_OUT("\n-----> Sending to remote unit after adding string\n");
                 appl_hfag_standalone_read_pl(buffer, BT_str_len(buffer));
                 break;

        case HFP_UNIT_INCALL_ALERT:
                      CONSOLE_OUT("\n-----> Sending to remote unit after adding string\n");
                      appl_hfag_standalone_read_pl(HFP_UNIT_CLIP_STR, BT_str_len(HFP_UNIT_CLIP_STR));
                      break;
        ...
        default:
            CONSOLE_OUT("\n ------->> Bridge App : Sending to remote UNIT \n");
            appl_hfag_standalone_read_pl((UCHAR*)data, data_len);
            break;
    }
           ...
           )
{
    ...
    CONSOLE_OUT("> API RETVAL BT_hfp_unit_start : 0x%04X\n", api_retval);
    ...
    if (API_SUCCESS == api_retval)
    {
        ...
        CONSOLE_OUT("> HF Profile Started Successfully\n");
    }
