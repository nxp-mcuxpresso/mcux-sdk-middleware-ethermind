...
#ifndef _H_LC3_ODSP_API_
#define _H_LC3_ODSP_API_

/* --------------------------------------------- Header File Inclusion */
#include "LC3_odsp_internal.h"
...
#define  LC3_DECODER_CORE_BUFFER_SIZE_MAX             5104   /* 5216 */
...
#define LC3_DEC_SET_CONFIG_PARAMS lc3_odsp_dec_set_config_params
#define LC3_ENC_SET_CONFIG_PARAMS lc3_odsp_enc_set_config_params
 ...
 */
INT32 lc3_odsp_enc_set_config_params(
 ...
 * initialization of the config, which will be shared for all the channels in a CIG or BIG
 */
INT32 lc3_odsp_dec_set_config_params(
