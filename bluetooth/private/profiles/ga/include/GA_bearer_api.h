...
/**
 * \name Bearer Cryptographic events
 * \{
 * \brief Describes events associated with Bearer Crypto modules
 */
...
/**
 *  \defgroup ga_brr_attrval_len Attribute Value Length
 *  \{
 */
...
/**
* \name Bearer Constants - Cryptographic blocks
* \{
...
#define GA_brr_rpa_create(pid, irk, context) \
        GA_brr_rpa_operate((pid), NULL, (irk), (context))

#define GA_brr_rpa_verify(pid, addr, irk, context) \
        GA_brr_rpa_operate((pid), (addr), (irk), (context))
