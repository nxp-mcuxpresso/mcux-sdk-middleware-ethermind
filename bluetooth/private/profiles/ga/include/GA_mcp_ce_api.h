...
/**
 * This event indicates the setup of a GMCS Session.
 * \if MCP_SUPPORT_OBJECT_TRANSFER
 *   If \ref MCP_SUPPORT_OBJECT_TRANSFER is enabled, then the OTP Session is
 *   also established for GMCS Session.
 * \endif
 * A handle to the GMCS Session is derived and provided to the
...
/**
 * This event indicates the setup of a MCS Session.
 * A handle to the MCS Session is derived and provided to the
 * application, this Handle to be further used during all MCP Client related
 * requests.
 ...
 * \return \ref GA_SUCCESS (always)
 */
#define MCP_CE_READ_SEARCH_RES_OBJ_CNF        0x3CU
#endif /* MCP_SUPPORT_OBJECT_TRANSFER */
 ...
 * \return \ref GA_SUCCESS (always)
 */
#define MCP_CE_READ_CONTENT_CONTROL_ID_CNF    0x3DU
 ...
 * \return \ref GA_SUCCESS (always)
 */
#define MCP_CE_RELEASE_CNF                              0x49U
 ...
 * \return \ref GA_SUCCESS (always)
 */
#define MCP_CE_RELEASE_MCS_CNF                          0x4AU
