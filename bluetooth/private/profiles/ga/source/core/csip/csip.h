...
/** CSIP Set Handle */
typedef CSIP_HANDLE CSIP_SET_HANDLE;

/** CSIP Member Handle */
typedef CSIP_HANDLE CSIP_MEMBER_HANDLE;
...
typedef struct _CSIP_EVENT_INFO
{
    ...
    /** CS Handle - Client: Context Handle, Server: Member Handle */
    CSIP_HANDLE handle;
...
#define CSIP_RSI_CREATE_COMPLETE                    0xE0U
#define CSIP_RSI_VERIFY_COMPLETE                    0xE1U
