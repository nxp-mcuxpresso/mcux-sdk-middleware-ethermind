...
typedef void (*CSIP_CRYPTO_HANDLER)(GA_RESULT status, UCHAR * mac, UINT16 maclen);
...
GA_RESULT csip_profile_nullcontext_event_handler
          (
...
void csip_s1_complete(GA_RESULT status, UCHAR * mac, UINT16 maclen);
void csip_k1t_complete(GA_RESULT status, UCHAR * mac, UINT16 maclen);
void csip_k1_complete(GA_RESULT status, UCHAR * mac, UINT16 maclen);
