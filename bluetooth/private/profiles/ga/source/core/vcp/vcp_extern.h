...
extern DECL_CONST GA_CHAR_UUID vcp_vcs_uuid[VCS_CHAR_ID_COUNT];
extern DECL_CONST GA_CHAR_UUID vcp_vocs_uuid[VOCS_CHAR_ID_COUNT];
extern DECL_CONST GA_CHAR_UUID vcp_aics_uuid[AICS_CHAR_ID_COUNT];
